...
1. If you haven't already, install Visual Studio Code and the latest AL Language extension for version 16.0 as outlined in [Getting Started with AL](../developer/devenv-get-started.md).
