...
```json
GET https://api.businesscentral.dynamics.com/v1.0/api/beta/companies({id})/retainedEarningsStatement?$orderby=lineNumber&$filter=dateFilter ge 2019-01-01 and dateFilter le 2020-12-31
```
