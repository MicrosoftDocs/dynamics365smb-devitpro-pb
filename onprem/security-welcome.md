...
<p> This is the security hardening landing page...</p>
 <ul class="pivots">
    <li>
                ...
                <li>
                    ...
                    <ul id="products1" class="cardsC cols cols3">
                        <li>
						    ...
						    <p>Security learning for developers, architects, and engineers.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
												...
												<p>Security learning for application consultants.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
