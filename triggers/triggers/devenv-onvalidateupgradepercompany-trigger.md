---
title: OnValidateUpgradePerCompany Trigger in AL for Business Central
description: Learn how the OnValidateUpgradePerCompany trigger runs in AL upgrade codeunits in Business Central once for each company to check that an upgrade succeeded.
ms.date: 04/01/2021
ms.topic: reference
ms.reviewer: solsen
ms.author: solsen
