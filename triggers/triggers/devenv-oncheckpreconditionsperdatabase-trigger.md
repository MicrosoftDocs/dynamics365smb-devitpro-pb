---
title: OnCheckPreconditionsPerDatabase Trigger in AL
description: Learn how the OnCheckPreconditionsPerDatabase trigger runs once per database in AL upgrade codeunits to verify requirements before an extension upgrade starts.
ms.date: 04/01/2021
ms.topic: reference
ms.reviewer: solsen
ms.author: solsen
