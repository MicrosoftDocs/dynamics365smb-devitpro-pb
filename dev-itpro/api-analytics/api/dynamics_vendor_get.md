---
title: Get vendors
description: Gets a vendor object in Dynamics 365 Business Central analytics API.
...
```
GET businesscentralPrefix/api/microsoft/analytics/v1.0/companies({companyId})/vendors
```
...
```json
GET https://{businesscentralPrefix}/api/microsoft/analytics/v1.0/companies({companyId})/vendors
```
