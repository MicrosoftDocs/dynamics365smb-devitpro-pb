---
title: Get customers
description: Gets a customer object in Dynamics 365 Business Central analytics API.
...
```
GET businesscentralPrefix/api/microsoft/analytics/v1.0/companies({companyId})/customers
```
...
```json
GET https://{businesscentralPrefix}/api/microsoft/analytics/v1.0/companies({companyId})/customers
```
