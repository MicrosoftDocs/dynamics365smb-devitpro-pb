...
The release notes are pulled from all pull requests checked in since the last release. The auto-generated release note also contains a list of the new contributors and a link to the full changelog. 
