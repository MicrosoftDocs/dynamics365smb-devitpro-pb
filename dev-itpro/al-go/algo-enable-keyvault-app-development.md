...
- A `KeyVaultClientId`, which is the Client ID for the Microsoft Entra ID App with access to the key vault.
- A `KeyVaultCertificateUrl`, pointing to a certificate, which gives you access to the Microsoft Entra ID App.
