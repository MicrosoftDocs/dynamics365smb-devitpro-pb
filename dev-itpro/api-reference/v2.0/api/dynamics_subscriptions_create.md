...
> [!IMPORTANT]  
> Handshake is mandatory when [creating a subscription](dynamics-subscriptions_create.md) and [renewing a subscription](dynamics-subscriptions_update.md). See [Working with Webhooks](../dynamics-subscriptions.md).  
