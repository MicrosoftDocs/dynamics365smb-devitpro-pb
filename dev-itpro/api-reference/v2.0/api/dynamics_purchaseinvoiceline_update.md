...
|If-Match      |Required. When this request header is included and the eTag provided doesn't match the current tag on the **purchaseInvoiceLines**, the **purchaseInvoiceLines** won't be updated. |
