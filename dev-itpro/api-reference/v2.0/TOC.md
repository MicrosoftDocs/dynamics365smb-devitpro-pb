...
### [Create external event subscriptions](api/dynamics_externaleventsubscriptions_create.md)
### [Update external event subscriptions](api/dynamics_externaleventsubscriptions_update.md)
