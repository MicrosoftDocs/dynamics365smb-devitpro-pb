...
## [Customer contact](resources/dynamics_customercontact.md)
### [Get customer contact](api/dynamics_customercontact_get.md)
### [Delete customer contact](api/dynamics_customercontact_delete.md)
### [Update customer contact](api/dynamics_customercontact_update.md)
### [Get customer contact](api/dynamics_customercontact_get.md)
...
## [Dispute status](resources/dynamics_disputestatus.md)
...
### [Create externaleventsubscriptions](api/dynamics_externaleventsubscriptions_create.md)
### [Update externaleventsubscriptions](api/dynamics_externaleventsubscriptions_update.md)
...
## [General ledger setup](resources/dynamics_generalledgersetup.md)
...
### [Get item variant](api/dynamics_itemvariant_get.md)
## [Job queue entry](resources/dynamics_jobqueueentry.md)
### [Get job queue entry](api/dynamics_jobqueueentry_get.md)
## [Job queue log entry](resources/dynamics_jobqueuelogentry.md)
### [Get job queue log entry](api/dynamics_jobqueuelogentry_get.md)
...
## [Salesperson purchaser](resources/dynamics_salespersonpurchaser.md)
### [Get salesperson purchaser](api/dynamics_salespersonpurchaser_get.md)
### [Delete salesperson purchaser](api/dynamics_salespersonpurchaser_delete.md)
### [Create salesperson purchaser](api/dynamics_salespersonpurchaser_create.md)
### [Update salesperson purchaser](api/dynamics_salespersonpurchaser_update.md)
