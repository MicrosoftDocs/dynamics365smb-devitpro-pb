...
Deletes records on a subpage of the current page.  
 ...
 Executing the Delete\_\<part> operation in a web service first executes the [OnDeleteRecord Trigger](../developer/triggers-auto/page/devenv-OnDeleteRecord-page-Trigger.md) on the designated record of the subpage. If application code in the OnDeleteRecord trigger for the record of the subpage returns **true**, then the [OnDelete Trigger](../developer/page/triggers-auto/devenv-OnDelete-page-Trigger.md) for the corresponding table is executed. If no fault occurs, then the record of the subpage is deleted from the database.  
