...
SOAP web services enable full flexibility for building operation-centric services. They provide industry-standard interoperability and channel and host pluggability.  
 ...
 You can use SOAP to interact with page or codeunit web services in [!INCLUDE[prodshort](includes/prodshort.md)] .  
...
|Learn how to write code that provides a list of existing companies in a [!INCLUDE[prodshort](includes/prodshort.md)] database.|[How to: Use SystemService to Find Companies](How-to--Use-SystemService-to-Find-Companies.md)|  
