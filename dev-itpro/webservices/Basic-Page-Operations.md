...
These operations match the actions a user can perform by interacting with a page using the [prod_short](../includes/prod_short.md) client. The same page- and table-based business logic is executed.  
