...
#### [Agent lifecycle telemetry](administration/telemetry-agent-lifecycle-trace.md)
...
#### [API metadata validation telemetry](administration/telemetry-api-metadata-validation-trace.md)
#### [App key vault secret telemetry](administration/telemetry-extension-key-vault-trace.md)
#### [App resource exposure policy telemetry](administration/telemetry-app-resource-exposure-trace.md)
...
#### [Business events telemetry](administration/telemetry-business-events-trace.md)
...
#### [SQL query trace telemetry](administration/telemetry-sql-query-trace.md)
...
<!-- start Analytics API reference -->
#### Analytics API reference
##### [Analytics API overview](api-analytics/api-analytics-overview.md)
##### [abcAnalysisSetup](api-analytics/resources/dynamics_abcanalysissetup.md)
###### [Get abcAnalysisSetup](api-analytics/api/dynamics_abcanalysissetup_get.md)
##### [accountCategory](api-analytics/resources/dynamics_accountcategory.md)
###### [Get accountCategory](api-analytics/api/dynamics_accountcategory_get.md)
##### [assemblyHeader](api-analytics/resources/dynamics_assemblyheader.md)
###### [Get assemblyHeader](api-analytics/api/dynamics_assemblyheader_get.md)
##### [assemblyLine](api-analytics/resources/dynamics_assemblyline.md)
###### [Get assemblyLine](api-analytics/api/dynamics_assemblyline_get.md)
##### [balanceSheetGeneralLedgerEntry](api-analytics/resources/dynamics_balancesheetgeneralledgerentry.md)
###### [Get balanceSheetGeneralLedgerEntry](api-analytics/api/dynamics_balancesheetgeneralledgerentry_get.md)
##### [bin](api-analytics/resources/dynamics_bin.md)
###### [Get bin](api-analytics/api/dynamics_bin_get.md)
##### [calendarEntry](api-analytics/resources/dynamics_calendarentry.md)
###### [Get calendarEntry](api-analytics/api/dynamics_calendarentry_get.md)
##### [capacityLedgerEntry](api-analytics/resources/dynamics_capacityledgerentry.md)
###### [Get capacityLedgerEntry](api-analytics/api/dynamics_capacityledgerentry_get.md)
##### [closeIncomeStmtSourceCode](api-analytics/resources/dynamics_closeincomestmtsourcecode.md)
###### [Get closeIncomeStmtSourceCode](api-analytics/api/dynamics_closeincomestmtsourcecode_get.md)
##### [closeOpportunityCode](api-analytics/resources/dynamics_closeopportunitycode.md)
###### [Get closeOpportunityCode](api-analytics/api/dynamics_closeopportunitycode_get.md)
##### [closingGeneralLedgerEntry](api-analytics/resources/dynamics_closinggeneralledgerentry.md)
###### [Get closingGeneralLedgerEntry](api-analytics/api/dynamics_closinggeneralledgerentry_get.md)
##### [contact](api-analytics/resources/dynamics_contact.md)
###### [Get contact](api-analytics/api/dynamics_contact_get.md)
##### [customer](api-analytics/resources/dynamics_customer.md)
###### [Get customer](api-analytics/api/dynamics_customer_get.md)
##### [customerLedgerEntry](api-analytics/resources/dynamics_customerledgerentry.md)
###### [Get customerLedgerEntry](api-analytics/api/dynamics_customerledgerentry_get.md)
##### [dateSetup](api-analytics/resources/dynamics_datesetup.md)
###### [Get dateSetup](api-analytics/api/dynamics_datesetup_get.md)
##### [dimension](api-analytics/resources/dynamics_dimension.md)
###### [Get dimension](api-analytics/api/dynamics_dimension_get.md)
##### [dimensionSetEntry](api-analytics/resources/dynamics_dimensionsetentry.md)
###### [Get dimensionSetEntry](api-analytics/api/dynamics_dimensionsetentry_get.md)
##### [dynamicDimension](api-analytics/resources/dynamics_dynamicdimension.md)
###### [Get dynamicDimension](api-analytics/api/dynamics_dynamicdimension_get.md)
##### [fromBinWarehouseJournalLine](api-analytics/resources/dynamics_frombinwarehousejournalline.md)
###### [Get fromBinWarehouseJournalLine](api-analytics/api/dynamics_frombinwarehousejournalline_get.md)
##### [generalLedgerAccount](api-analytics/resources/dynamics_generalledgeraccount.md)
###### [Get generalLedgerAccount](api-analytics/api/dynamics_generalledgeraccount_get.md)
##### [generalLedgerAccountCategory](api-analytics/resources/dynamics_generalledgeraccountcategory.md)
###### [Get generalLedgerAccountCategory](api-analytics/api/dynamics_generalledgeraccountcategory_get.md)
##### [generalLedgerBudget](api-analytics/resources/dynamics_generalledgerbudget.md)
###### [Get generalLedgerBudget](api-analytics/api/dynamics_generalledgerbudget_get.md)
##### [generalLedgerBudgetEntry](api-analytics/resources/dynamics_generalledgerbudgetentry.md)
###### [Get generalLedgerBudgetEntry](api-analytics/api/dynamics_generalledgerbudgetentry_get.md)
##### [generalLedgerSetup](api-analytics/resources/dynamics_generalledgersetup.md)
###### [Get generalLedgerSetup](api-analytics/api/dynamics_generalledgersetup_get.md)
##### [incomeStatementGeneralLedgerEntry](api-analytics/resources/dynamics_incomestatementgeneralledgerentry.md)
###### [Get incomeStatementGeneralLedgerEntry](api-analytics/api/dynamics_incomestatementgeneralledgerentry_get.md)
##### [incomeStmtGeneralLedgerEntry](api-analytics/resources/dynamics_incomestmtgeneralledgerentry.md)
###### [Get incomeStmtGeneralLedgerEntry](api-analytics/api/dynamics_incomestmtgeneralledgerentry_get.md)
##### [inventoryAdjustmentEntryOrder](api-analytics/resources/dynamics_inventoryadjustmententryorder.md)
###### [Get inventoryAdjustmentEntryOrder](api-analytics/api/dynamics_inventoryadjustmententryorder_get.md)
##### [inventoryProdOrderComponentLine](api-analytics/resources/dynamics_inventoryprodordercomponentline.md)
###### [Get inventoryProdOrderComponentLine](api-analytics/api/dynamics_inventoryprodordercomponentline_get.md)
##### [inventoryProdOrderLine](api-analytics/resources/dynamics_inventoryprodorderline.md)
###### [Get inventoryProdOrderLine](api-analytics/api/dynamics_inventoryprodorderline_get.md)
##### [item](api-analytics/resources/dynamics_item.md)
###### [Get item](api-analytics/api/dynamics_item_get.md)
##### [itemBudget](api-analytics/resources/dynamics_itembudget.md)
###### [Get itemBudget](api-analytics/api/dynamics_itembudget_get.md)
##### [itemCategory](api-analytics/resources/dynamics_itemcategory.md)
###### [Get itemCategory](api-analytics/api/dynamics_itemcategory_get.md)
##### [itemJobPlanningLine](api-analytics/resources/dynamics_itemjobplanningline.md)
###### [Get itemJobPlanningLine](api-analytics/api/dynamics_itemjobplanningline_get.md)
##### [itemLedgerEntry](api-analytics/resources/dynamics_itemledgerentry.md)
###### [Get itemLedgerEntry](api-analytics/api/dynamics_itemledgerentry_get.md)
##### [itemOutstandingPurchaseLine](api-analytics/resources/dynamics_itemoutstandingpurchaseline.md)
###### [Get itemOutstandingPurchaseLine](api-analytics/api/dynamics_itemoutstandingpurchaseline_get.md)
##### [itemOutstandingSalesLine](api-analytics/resources/dynamics_itemoutstandingsalesline.md)
###### [Get itemOutstandingSalesLine](api-analytics/api/dynamics_itemoutstandingsalesline_get.md)
##### [itemReceivedNotInvoicedPurchaseLine](api-analytics/resources/dynamics_itemreceivednotinvoicedpurchaseline.md)
###### [Get itemReceivedNotInvoicedPurchaseLine](api-analytics/api/dynamics_itemreceivednotinvoicedpurchaseline_get.md)
##### [itemShippedNotInvoicedSalesLine](api-analytics/resources/dynamics_itemshippednotinvoicedsalesline.md)
###### [Get itemShippedNotInvoicedSalesLine](api-analytics/api/dynamics_itemshippednotinvoicedsalesline_get.md)
##### [itemValueEntry](api-analytics/resources/dynamics_itemvalueentry.md)
###### [Get itemValueEntry](api-analytics/api/dynamics_itemvalueentry_get.md)
##### [job](api-analytics/resources/dynamics_job.md)
###### [Get job](api-analytics/api/dynamics_job_get.md)
##### [jobLedgerEntry](api-analytics/resources/dynamics_jobledgerentry.md)
###### [Get jobLedgerEntry](api-analytics/api/dynamics_jobledgerentry_get.md)
##### [jobOutstandingPurchaseLine](api-analytics/resources/dynamics_joboutstandingpurchaseline.md)
###### [Get jobOutstandingPurchaseLine](api-analytics/api/dynamics_joboutstandingpurchaseline_get.md)
##### [jobPlanningLine](api-analytics/resources/dynamics_jobplanningline.md)
###### [Get jobPlanningLine](api-analytics/api/dynamics_jobplanningline_get.md)
##### [jobReceivedNotInvoicedPurchaseLine](api-analytics/resources/dynamics_jobreceivednotinvoicedpurchaseline.md)
###### [Get jobReceivedNotInvoicedPurchaseLine](api-analytics/api/dynamics_jobreceivednotinvoicedpurchaseline_get.md)
##### [jobTask](api-analytics/resources/dynamics_jobtask.md)
###### [Get jobTask](api-analytics/api/dynamics_jobtask_get.md)
##### [location](api-analytics/resources/dynamics_location.md)
###### [Get location](api-analytics/api/dynamics_location_get.md)
##### [machineCenter](api-analytics/resources/dynamics_machinecenter.md)
###### [Get machineCenter](api-analytics/api/dynamics_machinecenter_get.md)
##### [manufacturingProdOrderComponent](api-analytics/resources/dynamics_manufacturingprodordercomponent.md)
###### [Get manufacturingProdOrderComponent](api-analytics/api/dynamics_manufacturingprodordercomponent_get.md)
##### [manufacturingProdOrderLines](api-analytics/resources/dynamics_manufacturingprodorderlines.md)
###### [Get manufacturingProdOrderLines](api-analytics/api/dynamics_manufacturingprodorderlines_get.md)
##### [manufacturingProductionOrder](api-analytics/resources/dynamics_manufacturingproductionorder.md)
###### [Get manufacturingProductionOrder](api-analytics/api/dynamics_manufacturingproductionorder_get.md)
##### [manufacturingSetup](api-analytics/resources/dynamics_manufacturingsetup.md)
###### [Get manufacturingSetup](api-analytics/api/dynamics_manufacturingsetup_get.md)
##### [manufacturingValueEntry](api-analytics/resources/dynamics_manufacturingvalueentry.md)
###### [Get manufacturingValueEntry](api-analytics/api/dynamics_manufacturingvalueentry_get.md)
##### [opportunity](api-analytics/resources/dynamics_opportunity.md)
###### [Get opportunity](api-analytics/api/dynamics_opportunity_get.md)
##### [opportunityEntry](api-analytics/resources/dynamics_opportunityentry.md)
###### [Get opportunityEntry](api-analytics/api/dynamics_opportunityentry_get.md)
##### [orderServiceLine](api-analytics/resources/dynamics_orderserviceline.md)
###### [Get orderServiceLine](api-analytics/api/dynamics_orderserviceline_get.md)
##### [outstandingPurchaseLine](api-analytics/resources/dynamics_outstandingpurchaseline.md)
###### [Get outstandingPurchaseLine](api-analytics/api/dynamics_outstandingpurchaseline_get.md)
##### [outstandingSalesLine](api-analytics/resources/dynamics_outstandingsalesline.md)
###### [Get outstandingSalesLine](api-analytics/api/dynamics_outstandingsalesline_get.md)
##### [pbiCountryRegion](api-analytics/resources/dynamics_pbicountryregion.md)
###### [Get pbiCountryRegion](api-analytics/api/dynamics_pbicountryregion_get.md)
##### [pbiEmissionFee](api-analytics/resources/dynamics_pbiemissionfee.md)
###### [Get pbiEmissionFee](api-analytics/api/dynamics_pbiemissionfee_get.md)
##### [pbiEmployee](api-analytics/resources/dynamics_pbiemployee.md)
###### [Get pbiEmployee](api-analytics/api/dynamics_pbiemployee_get.md)
##### [pbiEmployeeAbsence](api-analytics/resources/dynamics_pbiemployeeabsence.md)
###### [Get pbiEmployeeAbsence](api-analytics/api/dynamics_pbiemployeeabsence_get.md)
##### [pbiEmployeeLedgerEntry](api-analytics/resources/dynamics_pbiemployeeledgerentry.md)
###### [Get pbiEmployeeLedgerEntry](api-analytics/api/dynamics_pbiemployeeledgerentry_get.md)
##### [pbiEmployeeQualification](api-analytics/resources/dynamics_pbiemployeequalification.md)
###### [Get pbiEmployeeQualification](api-analytics/api/dynamics_pbiemployeequalification_get.md)
##### [pbiResponsibilityCentre](api-analytics/resources/dynamics_pbiresponsibilitycentre.md)
###### [Get pbiResponsibilityCentre](api-analytics/api/dynamics_pbiresponsibilitycentre_get.md)
##### [pbiSustainabilityAccount](api-analytics/resources/dynamics_pbisustainabilityaccount.md)
###### [Get pbiSustainabilityAccount](api-analytics/api/dynamics_pbisustainabilityaccount_get.md)
##### [pbiSustainabilityAccountCategory](api-analytics/resources/dynamics_pbisustainabilityaccountcategory.md)
###### [Get pbiSustainabilityAccountCategory](api-analytics/api/dynamics_pbisustainabilityaccountcategory_get.md)
##### [pbiSustainabilityGoal](api-analytics/resources/dynamics_pbisustainabilitygoal.md)
###### [Get pbiSustainabilityGoal](api-analytics/api/dynamics_pbisustainabilitygoal_get.md)
##### [pbiSustainabilityLedgerEntry](api-analytics/resources/dynamics_pbisustainabilityledgerentry.md)
###### [Get pbiSustainabilityLedgerEntry](api-analytics/api/dynamics_pbisustainabilityledgerentry_get.md)
##### [pbiSustainabilitySubAccountCategory](api-analytics/resources/dynamics_pbisustainabilitysubaccountcategory.md)
###### [Get pbiSustainabilitySubAccountCategory](api-analytics/api/dynamics_pbisustainabilitysubaccountcategory_get.md)
##### [planningComponentLine](api-analytics/resources/dynamics_planningcomponentline.md)
###### [Get planningComponentLine](api-analytics/api/dynamics_planningcomponentline_get.md)
##### [prodItemLedgerEntry](api-analytics/resources/dynamics_proditemledgerentry.md)
###### [Get prodItemLedgerEntry](api-analytics/api/dynamics_proditemledgerentry_get.md)
##### [prodOrderCapacityNeed](api-analytics/resources/dynamics_prodordercapacityneed.md)
###### [Get prodOrderCapacityNeed](api-analytics/api/dynamics_prodordercapacityneed_get.md)
##### [prodOrderRoutingLine](api-analytics/resources/dynamics_prodorderroutingline.md)
###### [Get prodOrderRoutingLine](api-analytics/api/dynamics_prodorderroutingline_get.md)
##### [purchaseCreditMemoLine](api-analytics/resources/dynamics_purchasecreditmemoline.md)
###### [Get purchaseCreditMemoLine](api-analytics/api/dynamics_purchasecreditmemoline_get.md)
##### [purchaseInvoiceLine](api-analytics/resources/dynamics_purchaseinvoiceline.md)
###### [Get purchaseInvoiceLine](api-analytics/api/dynamics_purchaseinvoiceline_get.md)
##### [purchaseItemBudgetEntry](api-analytics/resources/dynamics_purchaseitembudgetentry.md)
###### [Get purchaseItemBudgetEntry](api-analytics/api/dynamics_purchaseitembudgetentry_get.md)
##### [purchaseLine](api-analytics/resources/dynamics_purchaseline.md)
###### [Get purchaseLine](api-analytics/api/dynamics_purchaseline_get.md)
##### [purchaseValueEntry](api-analytics/resources/dynamics_purchasevalueentry.md)
###### [Get purchaseValueEntry](api-analytics/api/dynamics_purchasevalueentry_get.md)
##### [requisitionLine](api-analytics/resources/dynamics_requisitionline.md)
###### [Get requisitionLine](api-analytics/api/dynamics_requisitionline_get.md)
##### [resource](api-analytics/resources/dynamics_resource.md)
###### [Get resource](api-analytics/api/dynamics_resource_get.md)
##### [returnReasonCode](api-analytics/resources/dynamics_returnreasoncode.md)
###### [Get returnReasonCode](api-analytics/api/dynamics_returnreasoncode_get.md)
##### [routing](api-analytics/resources/dynamics_routing.md)
###### [Get routing](api-analytics/api/dynamics_routing_get.md)
##### [routingLink](api-analytics/resources/dynamics_routinglink.md)
###### [Get routingLink](api-analytics/api/dynamics_routinglink_get.md)
##### [salesCreditLine](api-analytics/resources/dynamics_salescreditline.md)
###### [Get salesCreditLine](api-analytics/api/dynamics_salescreditline_get.md)
##### [salesCrProjectLedgerEntry](api-analytics/resources/dynamics_salescrprojectledgerentry.md)
###### [Get salesCrProjectLedgerEntry](api-analytics/api/dynamics_salescrprojectledgerentry_get.md)
##### [salesCycleStage](api-analytics/resources/dynamics_salescyclestage.md)
###### [Get salesCycleStage](api-analytics/api/dynamics_salescyclestage_get.md)
##### [salesInvoiceLine](api-analytics/resources/dynamics_salesinvoiceline.md)
###### [Get salesInvoiceLine](api-analytics/api/dynamics_salesinvoiceline_get.md)
##### [salesInvoiceProjectLedgerEntry](api-analytics/resources/dynamics_salesinvoiceprojectledgerentry.md)
###### [Get salesInvoiceProjectLedgerEntry](api-analytics/api/dynamics_salesinvoiceprojectledgerentry_get.md)
##### [salesItemBudgetEntry](api-analytics/resources/dynamics_salesitembudgetentry.md)
###### [Get salesItemBudgetEntry](api-analytics/api/dynamics_salesitembudgetentry_get.md)
##### [salesLine](api-analytics/resources/dynamics_salesline.md)
###### [Get salesLine](api-analytics/api/dynamics_salesline_get.md)
##### [salespersonPurchaser](api-analytics/resources/dynamics_salespersonpurchaser.md)
###### [Get salespersonPurchaser](api-analytics/api/dynamics_salespersonpurchaser_get.md)
##### [salesValueEntry](api-analytics/resources/dynamics_salesvalueentry.md)
###### [Get salesValueEntry](api-analytics/api/dynamics_salesvalueentry_get.md)
##### [toBinWarehouseJournalLine](api-analytics/resources/dynamics_tobinwarehousejournalline.md)
###### [Get toBinWarehouseJournalLine](api-analytics/api/dynamics_tobinwarehousejournalline_get.md)
##### [transferLine](api-analytics/resources/dynamics_transferline.md)
###### [Get transferLine](api-analytics/api/dynamics_transferline_get.md)
##### [vendor](api-analytics/resources/dynamics_vendor.md)
###### [Get vendor](api-analytics/api/dynamics_vendor_get.md)
##### [vendorLedgerEntry](api-analytics/resources/dynamics_vendorledgerentry.md)
###### [Get vendorLedgerEntry](api-analytics/api/dynamics_vendorledgerentry_get.md)
##### [warehouseActivityLine](api-analytics/resources/dynamics_warehouseactivityline.md)
###### [Get warehouseActivityLine](api-analytics/api/dynamics_warehouseactivityline_get.md)
##### [warehouseEntry](api-analytics/resources/dynamics_warehouseentry.md)
###### [Get warehouseEntry](api-analytics/api/dynamics_warehouseentry_get.md)
##### [workCenter](api-analytics/resources/dynamics_workcenter.md)
###### [Get workCenter](api-analytics/api/dynamics_workcenter_get.md)
##### [workCenterGroup](api-analytics/resources/dynamics_workcentergroup.md)
###### [Get workCenterGroup](api-analytics/api/dynamics_workcentergroup_get.md)
##### [workingDay](api-analytics/resources/dynamics_workingday.md)
###### [Get workingDay](api-analytics/api/dynamics_workingday_get.md)
##### [zone](api-analytics/resources/dynamics_zone.md)
###### [Get zone](api-analytics/api/dynamics_zone_get.md)
<!-- end Analytics API reference -->
#### Finance reports API
<!-- START>DO_NOT_EDIT -->
<!-- IMPORTANT:Do not edit any of the content between here and the END>DO_NOT_EDIT. -->
