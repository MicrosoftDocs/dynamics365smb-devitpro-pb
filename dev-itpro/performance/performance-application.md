...
Installing a large number of apps (extensions) in your [!INCLUDE[prod_short](../developer/includes/prod_short.md)] environment can negatively impact performance in several ways:
