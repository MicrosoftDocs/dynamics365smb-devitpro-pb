...
- [SOAP Services Settings](../administration/server-instance-settings.md#expose-soap-services)  
- [OData Services Settings](../administration/server-instance-settings.md#expose-odata-and-api-services)  
