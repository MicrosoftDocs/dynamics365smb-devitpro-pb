...
- Then, use telemetry to find data about time spend in the report: long running SQL queries (eventId RT0005) and report rendering time (eventId RT0006) are the main data sources for this. Telemetry for long running AL methods (eventId RT00180 might also be useful here. Now you have baseline data.
