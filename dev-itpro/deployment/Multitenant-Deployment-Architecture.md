...
## Tenants, Companies, and Databases  
 ...
 When you deploy and maintain a [!INCLUDE[navnowlong](../developer/includes/navnowlong_md.md)] solution, you must activate the relationship between the [!INCLUDE[nav_server](../developer/includes/nav_server_md.md)] instance by mounting the tenant to the [!INCLUDE[nav_server](../developer/includes/nav_server_md.md)] instance. You can do this by using the [!INCLUDE[nav_admin](../developer/includes/nav_admin_md.md)] or by running the **Mount-NAVTenant** and **Sync-NAVTenant** cmdlets from the [!INCLUDE[nav_shell](../developer/includes/nav_shell_md.md)]. Similarly, to disconnect a tenant, you can use the [!INCLUDE[nav_admin](../developer/includes/nav_admin_md.md)] or run the **Dismount-NAVTenant** cmdlet. For more information, see [How to: Mount or Dismount a Tenant on a Microsoft Dynamics Server Instance](How-to--Mount-or-Dismount-a-Tenant-on-a-Microsoft-Dynamics-Server-Instance.md).  
...
## The Application in Multitenant Deployments  
 ...
 For example, you can create a dedicated administration tenant that you mount against the [!INCLUDE[nav_server](../developer/includes/nav_server_md.md)] instance when you create web services for an application.  
