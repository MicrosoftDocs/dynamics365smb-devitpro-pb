...
The SQL queries generated by Dynamics NAV are of OLTP type (many, small transactions). It is therefore recommended running Dynamics 365 Business Central with `MAXDOP` set to the value 1 as a starting point. Depending on the number of cores on your database server, you can increase this number. 
