...
|Specification|Requirement|
|-----|-----|
|Supported operating systems|<ul><li>Windows Server 2025</li><li>Windows Server 2022</li><li>Windows Server 2019</li><li>Windows 11</li><li>Windows 10</li></ul>Learn more about the supported versions and their lifecycles at [Windows lifecycle fact sheet](https://support.microsoft.com/help/13853/windows-lifecycle-fact-sheet).|
...
|Specification|Requirement|  
|-----|-----|  
|Supported operating systems|<ul><li>Windows 11 Pro, Enterprise, or Education \(64-bit edition, version 22H2 and later.\)</li><li>Windows 10 Pro, Enterprise, or Education \(64-bit edition, versions 22H2 and 21H2\)</li><li>Windows Server 2025 (Datacenter, Standard)</li><li>Windows Server 2022 (Datacenter, Standard)</li></ul>For information about the supported versions and their lifecycles, see [Windows lifecycle fact sheet](https://support.microsoft.com/help/13853/windows-lifecycle-fact-sheet).<!-- Windows Server 2022 ends mainstream support Oct 13, 2026; so need remove this for 2026w2. In version 25, Windows 10 will only support Version 22H2 -->|
...
|Specification|Requirement|  
|----|----|  
|Supported operating systems|<ul><li>Windows 11 Pro, Enterprise, or Education  \(64-bit edition, version 22H2 and later.\)</li><li>Windows 10 Pro, Enterprise, or Education \(64-bit edition, versions 22H2 and 21H2\)</li><li>Windows Server 2025 (Datacenter, Standard)</li><li>Windows Server 2022 (Datacenter, Standard)</li></ul>Learn more about the supported versions and their lifecycles at [Windows lifecycle fact sheet](https://support.microsoft.com/help/13853/windows-lifecycle-fact-sheet).<!--Windows Server 2022 ends mainstream support Oct 13, 2026; so need remove this for 2026w2. In version 25, Windows 10 will only support Version 22H2 -->|
...
|Database|<ul><li>Business Central supports database compatibility level 150 and 160 on SQL Server, Azure SQL Database, and Azure SQL Managed Instance. Learn more about  SQL Server Database compatibility levels at [ALTER DATABASE (Transact-SQL) Compatibility Level](/sql/t-sql/statements/alter-database-transact-sql-compatibility-level?view=sql-server-ver15&preserve-view=true).</li><li>If you use nonclustered column store (NCCI) indexes and deploy to Azure SQL Database, then the performance tier must be S3 or higher.</li><li>The **Full-text and Semantic Extractions for Search** feature is installed on the SQL Server instance.<!-- Compat level 150 (SQL Server 2019)  has Mainstream End Date on Feb 28, 2025 (so need to remove this compat level for 2025w1)-->|  
