...
1. Complete a technical upgrade of your current application to the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] version.
    ...
    This will convert your application database so that is runs on the new [!INCLUDE[prodshort](../developer/includes/prodshort.md)] platform. For more information, see [Converting a Database - Technical Upgrade](https://docs.microsoft.com/dynamics-nav/converting-a-database).
