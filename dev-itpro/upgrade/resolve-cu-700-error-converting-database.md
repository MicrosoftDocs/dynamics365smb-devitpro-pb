...
This article explains how to resolve the compilation error that you get for codeunit **700 Page Management** when converting a [!INCLUDE[nav2018_md](includes/nav2018_md.md)] database to  [!INCLUDE[prodhort](includes/prodshort.md)].
