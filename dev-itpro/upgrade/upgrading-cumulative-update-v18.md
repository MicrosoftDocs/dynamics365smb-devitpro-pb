...
1. Go to the [list of available updates](../deployment/update-versions-18.md) for your on-premises version of Business Central. Then, choose the update that you want.
