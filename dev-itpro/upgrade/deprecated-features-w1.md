...
|----|----|
|Replaced|The functionality is replaced with new calculations that you can extend to include additional sources or calculation methods. The current capabilities will be available, and can be used in parallel with the new, until 2020 release wave 2. For more information, see [Extending Best Price Calculations](..developer/devenv-extending-best-price-calculations.md).|
