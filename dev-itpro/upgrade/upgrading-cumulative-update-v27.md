...
```powershell
$BcServerInstance = "The name of the Business Central server instance, for example: BC270"
...
1. Go to the [list of available updates](../deployment/update-versions-27.md) for your on-premises version of Business Central. Then, choose the update that you want.
...
[Business Central on-premises 2025 release wave 2 updates](../deployment/update-versions-27.md)  
[Upgrading to Business Central 2025 release wave 2](upgrade-overview-v27.md)  
