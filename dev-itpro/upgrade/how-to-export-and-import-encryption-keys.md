...
You can encrypt data on the [!INCLUDE[nav_server](../developer/includes/nav_server_md.md)] instance by generating new encryption keys or importing or changing existing encryption keys that you enable on the server instance.  
