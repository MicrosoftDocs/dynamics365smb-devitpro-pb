...
[![Upgrade on unmodified Business Central application.](../developer/media/bc28-upgrade-unmodified-app.svg)](../developer/media/bc28-upgrade-unmodified-app.svg#lightbox)  

[!INCLUDE[upgrade_single_vs_multitenant](../developer/includes/upgrade_single_vs_multitenant.md)]

> [!IMPORTANT]
> You can't upgrade directly to version 28 from version 24 or earlier because there are several objects in these earlier versions that are ot included in version 28. Upgrade to version 25 first. Learn more about these objects in [Deleted objects](upgrade-considerations-v26.md#deleted-objects). To upgrade to version 25, follow the instructions in [Upgrading Microsoft system and base application to version 25](upgrade-unmodified-application-to-v25.md).  
...
1. Use the [Import-NAVServerLicense](/powershell/module/microsoft.dynamics.nav.management/import-navserverlicense) to upload the version 28 license to the database. 
...
The steps in this task continue to use the [!INCLUDE[adminshell](../developer/includes/adminshell.md)] for version 28 that you started in the previous task.
...
1. Recompile extensions not built on version 28.

    [!INCLUDE[repair_runtime_packages](../developer/includes/repair_runtime_packages.md)]

    Do this step for any published extension versions that aren't built on version 28, and you want to reinstall on tenants. These extensions must be recompiled to work with version 28. To recompile the extensions, use the [Repair-NAVApp](/powershell/module/microsoft.dynamics.nav.apps.management/repair-navapp) cmdlet:
