...
- Application extension
    ...
    The Application extension logically encapsulates all of the extensions making up a solution, for example, version `23.0.0.0` of the base and system application package files, and it provides a convenient way to define and refer to this solution identity. This extension is required for Microsoft extensions, but is optional for third-party extensions. For more information, see [The Microsoft_Application.app File](../developer/devenv-application-app-file.md).
...
$NewBcVersion = "The version number for the update, for example: 23.1.39901.0"
...
1. Go to the [list of available updates](../deployment/update-versions-23.md) for your on-premises version of Business Central. Then, choose the update that you want.
