...
|Moved, Removed, or Replaced?|Why?|When?|
|----|----|----|
|Moved|The functionality for Different types of disposal and maintenance in the Czech version has been moved to the Fixed Asset Localization for Czech extension. |2021 release wave 1|
