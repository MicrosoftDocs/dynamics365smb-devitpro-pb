---
title: Technical Upgrade From Version 19 to Version 23
description: Describes how to do a technical upgrade from Business Central V19 to V23
...
author: jswymer
---
# Technical upgrade from version 19 to version 23
...
$SystemAppVersion ="The version number for the new System Application extension, like 21.0.34582.0"
...
$BaseAppVersion ="The version number for the new base application extension, like 23.0.34582.0"
...
2. Before you install version 23, it can be useful to create desktop shortcuts to the version 16.0 tools, such as the [!INCLUDE[admintool](../developer/includes/admintool.md)], [!INCLUDE[adminshell](../developer/includes/adminshell.md)], and [!INCLUDE[devshell](../developer/includes/devshell.md)] because the Start menu items for these tools will be replaced with the version 23.0 tools.
...
Version 20 introduced platform-rendering of reports. To support this change, you'll have to modify the base application code to ensure that custom layouts run correctly after upgrade to version 23.
...
3. (Single-tenant only) Uninstall all extensions from the old tenants.
    ...
    Run the [!INCLUDE[adminshell](../developer/includes/adminshell.md)] for the previous version, like 19, as an administrator. [!INCLUDE[open-admin-shell](../developer/includes/open-admin-shell.md)]
...
## Task 5: Convert application database to version 23
...
## Task 6: Configure version 23 server
...
In this task, you'll upgrade the system application to version 23 and the base application to the new version you created in Task 3.
...
## Task 12:  Upgrade or reinstall extensions
