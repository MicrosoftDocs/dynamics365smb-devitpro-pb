...
3. Publish the version 15 system symbols extension.
    ...
    ```
4. Publish the custom base application extension that you created:
...
5. Publish the Microsoft and 3rd party extensions.
