...
While the average Business Central online customers has 20-30 full users, there are thousands of online customers with more than 100 users, including customers running with well over 1,000 users, underscoring the system's adaptability to diverse user demands and organizational sizes. In 2023, Business Central online experienced 105% YoY growth of the number of customers with more than 100 paid users. 
