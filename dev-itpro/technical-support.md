...
|---------|-------------|--------------------------------------------|
|Platform <\major>.\<\minor>.\<\build.\<\revision>\|14.0.29040.0 | Specifies the platform version, which includes client and server components. |
...
In the administration center, you can also see telemetry for your tenants.

For more information, see [The Business Central Administration Center](administration/tenant-admin-center.md).  
