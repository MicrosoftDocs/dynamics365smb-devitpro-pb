...
As an administrator, you can restore an existing environment from a time in the past, within the 28-day retention period that applies to both production and sandbox environments.  
