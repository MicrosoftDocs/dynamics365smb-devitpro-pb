...
- Power Platform environments that are [linked](tenant-admin-center-environments.md#linked-power-platform-environment) to the [!INCLUDE[prod_short](../developer/includes/prod_short.md)] environment you are restoring are not affected by this operation. The Power Platform environment will not be restored, and the [!INCLUDE[prod_short](../developer/includes/prod_short.md)] environment created as part of the restore operation will not be linked to any Power Platform environment.
