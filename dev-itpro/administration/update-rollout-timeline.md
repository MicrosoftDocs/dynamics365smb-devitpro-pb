...
|Last scheduled update date|June 1 |December 1|The last date you can choose to extend your upgrade date to. <!--Starting October 1, 2023, the update window is again 30 days after an update is available.-->|

> [!IMPORTANT]
> In 2023 release wave 2, we expect to return to an update window that again is *30 days after an update is available*. This window was temporarily extended during the CoViD-19 pandemic. Based on your feedback in 2022, we keep it at *60 days* until October 1, 2023.
>
