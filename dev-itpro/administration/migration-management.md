...
|Azure Data Lake|This option is available if the [!INCLUDE [prodshort](../developer/includes/prodshort.md)] online tenant is connected to Dynamics GP. For more information, see [Migrate Dynamics GP to Azure Data Lake](migrate-dynamics-gp.md#migrate-dynamics-gp-to-azure-data-lake).|
