...
|Dimension  | Description or value  |
|---------|---------|
|aadTenantId|Specifies the Microsoft Entra ID (Microsoft Entra ID) tenant ID used for Microsoft Entra ID authentication. For on-premises solutions that do not use Microsoft Entra ID authentication, this value is **common**.|
|alCallerAppName     | The name of the extension that emitted telemetry.      |
