...
```
POST /microsoft/automation/{apiVersion}/companies({companyId})/extensionUpload(0)/content
```
...
```json
POST https://microsoft/automation/{apiVersion}/companies({companyId})/extensionUpload(0)/content
Content-type: application/json
{
    "systemId" : "",
    "schedule" : "",
