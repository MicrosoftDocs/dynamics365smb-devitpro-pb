...
- The [Reported outages](/report-outage.md) page shows all reported outages in the tenant and is not filtered to show only outages reported for environments to which a partner has access.
