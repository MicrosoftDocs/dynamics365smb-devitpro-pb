...
## Monitoring Long Running SQL Queries using the Application Insights
...
|cloud_RoleName|Specifies the display name of the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] tenant. For on-premises, this is the same as the cloud_RoleInstance.||
|cloud_RoleInstance|Specifies the name of the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] tenant. ||
...
The following shows an example of the CustomDimensions column exported in CSV format.
...
|Environment type|Specifies the environment type of the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] solution, such as Production or Sandbox.|
...
|AL Stack Trace |Specifies the stack trace in AL.||
|AL Object Name|Specifies the name of the AL object that executed the SQL statement.||
|AL Object Type |Specifies the type of the AL object that executed the SQL statement.||
|Company Name |Specifies the display name of the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] company that was used at the time of execution. ||
|AL Object ID |Specifies the ID of the AL object that executed the SQL statement.||
