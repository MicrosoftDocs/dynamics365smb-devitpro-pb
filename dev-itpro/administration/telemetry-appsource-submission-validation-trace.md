...
description: Learn about the telemetry for publishing apps to Marketplace from Partner Center.  
author: jswymer
ms.topic: how-to
ms.devlang: al
ms.search.keywords: administration, tenant, admin, environment, sandbox, telemetry, Marketplace, validation
ms.date: 08/01/2021
ms.author: jswymer
ms.reviewer: jswymer
---

# Analyzing Marketplace submission validation telemetry

**APPLIES TO:** [!INCLUDE[prod_short](../includes/prod_short.md)] 2021 release wave 1, version 18.4, and later

When you submit an app to Marketplace using Partner Center, it starts an automated validation process. This technical validation process ensures the extensions in the app meet the technical requirements for going live. It goes through many of the same checks described in [technical validation](/dynamics365/business-central/dev-itpro/developer/devenv-checklist-submission).
...
> [!NOTE]  
> In order to start analyzing your validation results, use this troubleshooting guide [Dynamics 365 Business Central Troubleshooting Guide (TSG) - Marketplace Submission Results (SaaS)](https://github.com/microsoft/BCTech/tree/master/samples/AppInsights/TroubleShootingGuides/D365BC%20Troubleshooting%20Guides%20(TSG)/content/AppSource-Submission-TSG.ipynb).
...
1. Marketplace submission validation request started
...
11. Marketplace submission validation request completed (successfully or with failures)

To reduce the risk of failing the Marketplace validation process, review the [technical validation](/dynamics365/business-central/dev-itpro/developer/devenv-checklist-submission) checklist before you submit an app.

## <a name="validationrequeststarted"></a>Marketplace submission validation request started
...
|---------|-----|
|message|**Marketplace submission validation request started: {validationRequestId}**|
...
The following table explains other custom dimensions that are common to all Marketplace submission validation traces. 
...
## <a name="submissionrequestdiagnostic"></a>Diagnostic reported on Marketplace submission validation request
...
|Dimension|Description or value|
|---------|-----|
|message|**Diagnostic reported on Marketplace submission validation request: {validationRequestId}**|
...
|containsHotfix|Specifies whether the (Version, country-region) validation contains a hotfix of a Marketplace extension.|
|[See common custom dimensions](#other)||
<!--
...
## <a name="validationrequestcompleted"></a>Marketplace submission validation request completed successfully
...
|Dimension|Description or value|
|---------|-----|
|message|**Marketplace submission validation request completed successfully: {validationRequestId}**|
|severityLevel|**1**|
...
## <a name="submissionrequestcompletedwithfailures"></a>Marketplace submission validation request completed with failures
...
|Dimension|Description or value|
|---------|-----|
|message|**Marketplace submission validation request completed with failures: {validationRequestId}**|
|severityLevel|**3**|
