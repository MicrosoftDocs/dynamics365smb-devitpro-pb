...
Gets the operations that occurred on an environment.

```HTTP
GET /admin/{apiVersion}/applications/{applicationType}/environments/{environmentName}/operations
```
...
|EnvironmentAppUpdate<sup>1</sup> |App was updated either by the Admin Center or API update endpoint.| [Update an App in Admin Center](tenant-admin-center-manage-apps.md#update-installed-apps-with-environment-updates)<br><br>[Update Endpoint](administration-center-api_app_management.md#update-a-global-app)|
|EnvironmentAppInstall<sup>1</sup>|App was installed by using the tenant's **Extension Management** page or the API install endpoint.|[Extension Management Page](/dynamics365/business-central/ui-extensions-install-uninstall#install-an-extension)<br><br>[Install Endpoint](administration-center-api_app_management.md#install-a-global-app)|
