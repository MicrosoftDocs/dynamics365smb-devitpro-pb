...
<a name="ApplicationInsights"></a>This article describes how to set up a tenants to send telemetry data to Application Insights.
...
3. Now that you have the key, the way to enable this feature depends on whether your [!INCLUDE[server](../developer/includes/server.md)] instance is configured as a single-tenant or multitenant instance:
