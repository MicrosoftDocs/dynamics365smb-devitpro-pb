...
|---------|-----|
|eventId|**RT0031**|
|aadTenantId|The Microsoft Entra ID tenant ID that's used for Microsoft Entra authentication. For on-premises, if you aren't using Microsoft Entra authentication, this value is **common**. |
