...
Learn more about configuring the [!INCLUDE[server](../developer/includes/server.md)] instance in [Configuring Business Central Server](configure-server-instance.md).
