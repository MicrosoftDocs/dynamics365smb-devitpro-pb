...
> [!IMPORTANT]
> We recommend that you do not change from the default settings for these query hints, unless you are certain that the change will better suit your scenario.
