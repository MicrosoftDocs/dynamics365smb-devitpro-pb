...
Occasionally, updates are made available for the apps. App updates provide new features and fix known issues. So  updating apps to the latest available version is a good idea to keep your tenant up-to-date and running smoothly.
