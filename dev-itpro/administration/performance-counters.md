...
The following table describes the performance counters that are available in [!INCLUDE[prodshort](../developer/includes/prodshort.md)] for monitoring [!INCLUDE[nav_server](../developer/includes/nav_server_md.md)] instances.
