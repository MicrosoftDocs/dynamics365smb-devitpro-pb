...
In Business Central, there isn't a direct equivalent to the "Unit of Measure Schedules" table (IV40201) found in Dynamics GP. Schedules are not actually units of measure; they are an ID in Dynamics GP that holds a group of Units of Measure.  Business Central does not have UofM Schedules, it only stores Units of Measure that would be in the GP table IV40202.  However, Business Central does allow you to set up and manage multiple units of measure for items.
...
[Set up item units of measure - Business Central | Microsoft Learn](https://learn.microsoft.com/en-us/dynamics365/business-central/inventory-how-setup-units-of-measure)
