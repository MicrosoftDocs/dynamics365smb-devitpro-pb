...
```
GET /admin/v2.18/support/outageTypes/{outageType}/outageQuestions
```
...
```
GET /admin/v2.18/support/reportedoutages
```
...
POST /admin/v2.18/support/applications/{applicationFamily}/environments/{environmentName}/reportoutage
```
