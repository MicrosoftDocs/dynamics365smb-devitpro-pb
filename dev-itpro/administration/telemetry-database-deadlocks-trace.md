...
> [!IMPORTANT]
> For Business Central on-premises, you must turn on the **EnableDeadlockMonitoring** setting of the [!INCLUDE[server](../developer/includes/server.md)] instance to collect the telemetry. Learn more in [Configuring Business Central Server](configure-server-instance.md).
