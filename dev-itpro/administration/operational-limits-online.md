...
|---------|--------------------------------------------------------------------------------|------|
|Total data size (TB) | The total amount of the (compressed) data stored in the environment database. The amount includes size of keys/indexes and blob data. | 3 TB|
