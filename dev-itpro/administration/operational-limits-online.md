...
|Number of companies|Although Business Central does not have a technical limit on the number of companies in an environment, having many companies can cause administrative tasks (such as upgrades, point-in-time restores, and database exports) to take a very long time and potentially hit timeout values. Therefore, it is recommended to test both these procedures and typical usage scenarios extensively if you have more than fifty companies. | 50 |
