...
- its ID
- the Microsoft Entra ID Tenant ID of the publisher's organization
...
|**publisherAadTenantId**|The ID of the Microsoft Entra ID tenant that represents the publisher's organization.|string (uuid)|
...
The `principal` entity represents an Microsoft Entra ID user or application that has some level of access to an `app`.  
...
|Name|Description|Schema|
|---|---|---|
|**aadTenantId**|The ID of the Microsoft Entra ID Tenant the principal belongs to.|string (uuid)|
...
|Name|Description|Schema|
|---|---|---|
|**aadTenantId**|The ID of the customer's Microsoft Entra ID tenant.|string (uuid)|
...
|**environmentAadTenantId**|The ID of the customer's Microsoft Entra ID tenant.|string (uuid)|
