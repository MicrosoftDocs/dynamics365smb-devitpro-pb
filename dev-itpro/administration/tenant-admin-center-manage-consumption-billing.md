...
> [!NOTE]
> Partners that provide Azure cloud operations management (such as setting up and maintaining subscriptions and deployed resources) may be eligible for partner earned credit (PEC). Learn more in [Partner earned credits](partner-center/billing/partner-earned-credit).  
