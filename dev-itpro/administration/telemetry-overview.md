...
|Long running AL method trace|Provides information about long running AL methods.|![check mark for feature](../developer/media/check.png)|![check mark for feature](../developer/media/check.png)||[See...](telemetry-al-function-trace.md) |
