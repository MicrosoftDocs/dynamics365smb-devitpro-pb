...
|Incoming web service requests|Provides information about the execution time of incoming web service requests.|Both|[Analyzing Incoming Web Service Requests Telemetry](telemetry-webservices-trace.md)|
|Outgoing web service requests|Provides information about the execution time of outgoing web service requests.|Both|[Analyzing Outgoing Web Service Requests Telemetry](telemetry-webservices-outgoing-trace.md)|
