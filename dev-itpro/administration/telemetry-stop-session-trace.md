...
|Dimension|Description or value|
|---------|-----|
|aadTenantId|The Microsoft Entra ID (Microsoft Entra ID) tenant ID that's used for Microsoft Entra ID authentication. For on-premises, if you aren't using Microsoft Entra ID authentication, this value is **common**. |
