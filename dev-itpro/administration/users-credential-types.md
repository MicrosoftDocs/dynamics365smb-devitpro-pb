...
In [!INCLUDE[prodshort](../developer/includes/prodshort.md)] online, users are added through the Office 365 Admin Center. Once users are created in Office 365, they can be imported into the **Users** window in [!INCLUDE[d365fin](includes/d365fin_md.md)]. For more information, see [Managing Users and Permissions](ui-how-users-permissions.md) in the business functionality content.  
