...
## SQL Trace Events  
SQL trace events track a specific set of SQL statements that are executed from the [!INCLUDE[nav_server](../developer/includes/nav_server_md.md)] instance against the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] database on SQL Server.  
  
|Event trace provider|Keyword|Decimal value|Hexadecimal value|  
|-------------|-------------|-------------------|-----------------------|  
|Microsoft-DynamicsNAV-Server|SQLTracing|2|0x2|  
  
The event data that is collected includes: session ID, tenant ID, the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] user, and the SQL statement. For more information, see [Event Trace Data](Microsoft-Dynamics-NAV-Server-Trace-Events.md#ArgRef).  
...
The event data that is collected includes: session ID, tenant ID, [!INCLUDE[prodshort](../developer/includes/prodshort.md)] user, and the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] object ID. For more information, see [Event Trace Data](Microsoft-Dynamics-NAV-Server-Trace-Events.md#ArgRef).  
...
The event data that is collected includes: session ID, tenant ID, [!INCLUDE[prodshort](../developer/includes/prodshort.md)] user, C/ALC/AL function, C/AL statements, and line number. For more information, see [Event Trace Data](Microsoft-Dynamics-NAV-Server-Trace-Events.md#ArgRef).  
  
> [!IMPORTANT]  
>  If the [!INCLUDE[nav_server](../developer/includes/nav_server_md.md)] instance is not configured for full C/AL function tracing, then only root-level C/AL function will be traced. Statements and C/AL functions that are called from functions will not be traced. By default, the [!INCLUDE[nav_server](../developer/includes/nav_server_md.md)] instance is not configured for full C/AL functionf tracing. For information about how to specify full C/AL function tracing, see [Configuring Business Central Server](configure-server-instance.md).  
...
|lineNumber|Specifies the line number of the statement in the C/AL code of the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] object that was executed.|C/AL function trace events|  
...
|objectId|Specifies the ID of the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] object that was executed in the session.|Service calls trace events (ServiceCall)<br /><br /> C/AL function trace events (ALTracing)|  
|objectType|Specifies the [!INCLUDE[prodshort](../developer/includes/prodshort.md)] object type that executed by a C/AL function or statement. Values include the following: CodeUnit, Page, Query, Report, Table, and XMLport.|C/AL function trace events (ALTracing)|  
