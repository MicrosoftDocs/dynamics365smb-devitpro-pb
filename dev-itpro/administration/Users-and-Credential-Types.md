...
|**None**| For internal use on system sessions and typically should not be used. If you choose **None**, then the [!INCLUDE[nav_server](includes/nav_server_md.md)] instance cannot start.|
