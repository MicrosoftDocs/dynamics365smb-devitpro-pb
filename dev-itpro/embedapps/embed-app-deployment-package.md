...
> [!IMPORTANT]
> Dependencies of an app with `"publishOnly": "false"` should also be marked with `"publishOnly": "false"`, else the app that depends on them will fail to be installed. |
