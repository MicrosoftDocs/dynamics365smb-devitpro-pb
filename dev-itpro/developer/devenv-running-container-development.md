...
## Setup Business Central using the BCContainerHelper PowerShell module
...
## Setup Business Central using Docker commands
> [!TIP]  
...
After starting the docker container, you'll see log entries similar to the following:
