...
To view a new Role Center in the client, you must use the client to associate the Role Center page with a profile, and then change the client's Role Center setting under **My Settings**. For more information, see [Create Profile](/business-central/admin-users-profiles-roles#CreateProfile.md).
