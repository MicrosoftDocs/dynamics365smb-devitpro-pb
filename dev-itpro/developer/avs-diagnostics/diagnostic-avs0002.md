...
In the app.json file of the app you must specify the latest supported runtime version or lower. For more information, see [app.json file](../devenv-json-files.md#app.json-file) and [Choosing Runtime Version in AL](../devenv-choosing-runtime.md).
