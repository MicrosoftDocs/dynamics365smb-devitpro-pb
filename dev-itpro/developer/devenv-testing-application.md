...
> [!IMPORTANT]
> For Business Central on-premises, running automated tests is only possible with a Partner license or license that includes the Application Builder module.
