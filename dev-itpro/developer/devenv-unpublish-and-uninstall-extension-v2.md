...
You unpublish an extension on a [!INCLUDE[d365_server_md](includes/d365_server_md.md)] instance by using the [!INCLUDE[nav_shell_md](includes/nav_shell_md.md)].
