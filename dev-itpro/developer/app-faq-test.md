...
We recommend that you consider using Docker containers. Using the Get-BcArtifactUrl function in the NavContainerHelper PowerShell module get give you the artifact url for the latest sandbox build for the desired country. You don’t have to figure out what product version is active at time of submission. That function does that for you.
