...
When your app has passed all of our validations and has gone live to AppSource, customers can install your extension and use it for their business. But you're expected to keep it compliant with the service and update it if something changes.  

The following sections describe the different upgrade scenarios that we have seen play out as we update [!INCLUDE[prod_short](includes/prod_short.md)]. Learn more about your responsibility for keeping your app updated and the resources that are available to you in [Maintain AppSource apps and per-tenant extensions](app-maintain.md).  
