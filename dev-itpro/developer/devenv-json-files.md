...
|dependencies|No|List of dependencies for the extension package. For example: `"dependencies": [ {  "appId": "4805fd15-75a5-46a2-952f-39c1c4eab821", "name": "WeatherLibrary", "publisher": "Microsoft", "version": "1.0.0.0"},{}]`. <br>For dependencies to the System Application and Base Application if these have not been further customized, the `application` setting must be filled in with the version number. See `application` below.|
...
|application|Yes, if base application is referenced in the extension|The supported version of the base application package file, for example: "16.0.0.0". |
...
|migrations|No|Specifies a list of apps that the current app can migrate table schemas with. <br>The syntax is `"migrations": [{"id": "63ca2fa4-4f03-4f2b-a480-172fef340d3f"}]`|
