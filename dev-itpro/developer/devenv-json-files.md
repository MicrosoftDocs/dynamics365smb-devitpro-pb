...
|enableSqlInformationDebugger|Yes|Specifies whether the debugger shows the SQL information. For more information, see [Debugging SQL behavior](devenv-debugging.md#DebugSQL).|
