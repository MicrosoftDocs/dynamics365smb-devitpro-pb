...
|`tenant`|Specifies the ID of the tenant to connect to. You must provide this parameter when [!INCLUDE[d365fin_md](includes/d365fin_md.md)] is deployed in multitenant architecture. The tenant that you specify must be mounted on the [!INCLUDE[d365fin_server_md](includes/d365fin_server_md.md)] instance that the [!INCLUDE[d365fin_web_md](../includes/d365fin_web_md.md)] connects to. For more information, see [Multitenant Deployment Architecture](Multitenant-Deployment-Architecture.md).|
