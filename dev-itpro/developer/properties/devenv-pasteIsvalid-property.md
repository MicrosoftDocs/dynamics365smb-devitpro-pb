...
The [OnInsert Trigger](../triggers/table/devenv-oninsert-table-trigger.md) of the table is executed when a record is inserted by pasting.  
  
## See Also  

[OnInsert Trigger](../triggers/table/devenv-oninsert-table-trigger.md)
