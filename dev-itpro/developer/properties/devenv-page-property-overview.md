...
|[DataCaptionExpression property](devenv-datacaptionexpression-property.md)| True| -Request Page <br />  -Page <br /> |
...
|[Editable property](devenv-editable-property.md)| | -Table field <br />  -Request Page <br />  -Page <br />  -Page Label <br />  -Page Field <br />  -Page Group <br />  -Page System Part <br />  -Page Chart Part <br />  -Page Part <br /> |
...
|[InsertAllowed property](devenv-insertallowed-property.md)| True| -Request Page <br />  -Page <br /> |
...
|[LinksAllowed property](devenv-linksallowed-property.md)| | -Request Page <br />  -Page <br /> |
...
|[ModifyAllowed property](devenv-modifyallowed-property.md)| True| -Request Page <br />  -Page <br /> |
|[MultiLine property](devenv-multiline-property.md)| | -Page Label <br />  -Page Field <br /> |
|[MultipleNewLines property](devenv-multiplenewlines-property.md)| | -Request Page <br />  -Page <br /> |
...
|[ToolTip property](devenv-tooltip-property.md)| True| -Page Label <br />  -Page Field <br />  -Page Part <br />  -Page System Part <br />  -Page Chart Part <br />  -Page Action Area <br />  -Page Action <br />  -Page Action Group <br />  -Page Custom Action <br />  -Page System Action <br />  -Page File Upload Action <br />  -Report <br />  -Query Column <br />  -Table field <br /> |
