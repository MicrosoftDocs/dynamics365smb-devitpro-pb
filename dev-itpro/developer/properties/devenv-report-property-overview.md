...
The following properties all apply to the Report object, only some of these properties can be set for a Report extension object as specified below. This list is sorted alphabetically by property name. For Report properties sorted by method on a Report, see [Properties](devenv-properties).
...
|AutoCalcField| | -Xml Port Field Attribute<br />  -Xml Port Field Element<br />  -Report Column<br /> |
...
|DataItemLink| | -Report Data Item<br />  -Query Data Item<br /> |
|DataItemLinkReference| | -Report Data Item<br /> |
|DataItemTableView| | -Report Data Item<br /> |
|DecimalPlaces| | -Table Field<br />  -Page Field<br />  -Report Column<br /> |
|DefaultLayout| | -Report<br /> |
|DefaultRenderingLayout| | -Report<br /> |
...
|EnableExternalAssemblies| | -Report<br /> |
|EnableExternalImages| | -Report<br /> |
|EnableHyperlinks| | -Report<br /> |
|ExcelLayout| True| -Report<br />  -Report Extension<br /> |
|ExecutionTimeout| | -Report<br /> |
|Extensible| | -Report<br />  -Enum Type<br />  -Table<br />  -Page<br /> |
|IncludeCaption| | -Report Column<br /> |
|LayoutFile| | -Report Layout<br /> |
|MaximumDatasetSize| | -Report<br /> |
|MaximumDocumentCount| | -Report<br /> |
|MaxIteration| | -Report Data Item<br /> |
|MimeType| | -Report Layout<br /> |
...
|PaperSourceDefaultPage| | -Report<br /> |
|PaperSourceFirstPage| | -Report<br /> |
|PaperSourceLastPage| | -Report<br /> |
|PdfFontEmbedding| | -Report<br /> |
...
|PreviewMode| | -Report<br /> |
|PrintOnlyIfDetail| | -Report Data Item<br /> |
|ProcessingOnly| | -Report<br /> |
|RDLCLayout| True| -Report<br />  -Report Extension<br /> |
...
|ShowPrintStatus| | -Report<br /> |
|Summary| | -Report Layout<br /> |
|SummaryML| | -Report Layout<br /> |
|TransactionType| | -Xml Port<br />  -Report<br /> |
|Type| | -Report Layout<br />  -Entitlement<br /> |
|UsageCategory| | -Page<br />  -Report<br /> |
|UseRequestPage| | -Xml Port<br />  -Report<br /> |
|UseSystemPrinter| | -Report<br /> |
|UseTemporary| | -Xml Port Table Element<br />  -Report Data Item<br /> |
|WordLayout| True| -Report<br />  -Report Extension<br /> |
|WordMergeDataItem| | -Report<br /> |
