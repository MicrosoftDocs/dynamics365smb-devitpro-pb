...
It is possible to run BCPT scenario runs in AL-Go for GitHub. For more information, see [Workflow: Create new Performance Test App](https://github.com/microsoft/AL-Go/blob/main/RELEASENOTES.md#new-workflow-create-new-performance-test-app)
...
Please visit the [BCPT video page](https://github.com/microsoft/BCTech/blob/master/samples/BCPT/VIDEOS.md) for learning resources published as videos if you love to learn things this way.

Please visit the [BCPT blogs page](https://github.com/microsoft/BCTech/blob/master/samples/BCPT/BLOGS.md) for learning resources published as blogs if blogs is your thing.
