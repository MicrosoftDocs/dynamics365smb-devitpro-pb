...
1. Upgrade to at least [!INCLUDE[prod_short](prod_short.md)] to the lowest major and minor version that is available for deployment in the Business Central admin center. 
