...
> [!NOTE]  
> From [!INCLUDE[prod_short](../includes/prod_short.md)] 2023 release wave 2, it's possible to install a preview of AppSource apps on customer environments without publishing them as DEV extensions. Learn more in [Technical Validation FAQ](devenv-checklist-submission-app-preview.md).
