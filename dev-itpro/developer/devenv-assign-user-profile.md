...
|Field    |Description|  
|---------|---------------------------------------|  
|**User ID**|Choose the **AssistEdit** button to view all available user logins, select the relevant user, and then choose the **OK** button.<br /><br /> For more information, see <!--[How to: Create Microsoft Dynamics NAV Users](How-to--Create-Microsoft-Dynamics-NAV-Users.md)-->[Managing Users and Permissions](https://review.docs.microsoft.com/en-us/dynamics365/business-central/ui-how-users-permissions).|  
