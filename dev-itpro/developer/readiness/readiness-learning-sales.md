...
|**Microsoft Dynamics 365 Business Central Licensing topics**<br>Learn more about the Licensing and pricing of [!INCLUDE[d365_bus_central_md](../includes/d365_bus_central_md.md)]. The information on this page includes licensing decks, licensing guide, FAQs, transition guides, toolkits, and many more.|[Review](https://mbs.microsoft.com/partnersource/northamerica/pricing-ordering/licensing-policies/Dyn365PricingandLicensing)<br>[Join the Conversation](https://www.yammer.com/cloudpartnercommunity/)|
