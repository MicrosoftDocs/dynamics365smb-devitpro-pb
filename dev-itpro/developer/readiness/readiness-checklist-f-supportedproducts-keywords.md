...
Hide key| Enter a secret key that you use to preview your offer in Marketplace before going live. Note, this isn't a password and can only contain alphanumeric characters. *Example:* *SalesInventoryKey*.
