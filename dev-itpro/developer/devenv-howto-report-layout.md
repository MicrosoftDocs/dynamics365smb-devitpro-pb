...
| [Export the custom XML from the _Report layouts_ page and import it in Word](#export-the-custom-xml-from-the-report-layouts-page-and-import-it-in-word) | 2024 release wave 2 | 
...
### Export the custom XML from the _Report layouts_ page and import it in Word
...
1. On the **Add New Layout for a Report** dialog page, fill in the name of the layout, choose Word as Format Options, and enable the _Create a new layout of type Word from an existing report_ option. Click OK.
