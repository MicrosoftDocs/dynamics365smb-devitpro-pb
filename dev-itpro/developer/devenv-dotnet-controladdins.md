...
description: "Description of the process of declaring the usage of a .NET or Javascript add-in in AL"
author: solsen
ms.custom: na
ms.date: 12/12/2018
ms.reviewer: na
...
# .NET Control Add-Ins
In Microsoft [!INCLUDE[d365fin_long_md](includes/d365fin_long_md.md)] on-premises you can use existing .NET and Javascript control add-ins from the AL Language through .NET interoperability. For more information about .NET and Javascript add-ins, see [Creating and Using a Windows Client Control Add-in](https://docs.microsoft.com/en-us/dynamics-nav/walkthrough--creating-and-using-a-client-control-add-in).
...
We can now use the `Microsoft.Dynamics.Nav.Client.PingPong` from AL, just as we use a native control add-in.
