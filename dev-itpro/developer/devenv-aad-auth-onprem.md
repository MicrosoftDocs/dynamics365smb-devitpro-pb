---
title: "Use Microsoft Entra ID authentication for Business Central on-premises installations"
...
# Use Microsoft Entra ID Authentication for Business Central On-Premises Installations
...
To enable Microsoft Entra ID authentication, make sure to do as follows: 

- Use the `primaryTenantDomain` setting in the `launch.json` file to specify the URL of the Microsoft Entra ID organization or company associated with the Microsoft Entra ID tenant. For more information, see [Find tenant ID, domain name, user object ID](/partner-center/find-ids-and-domain-names) and [JSON Files](devenv-json-files.md).
