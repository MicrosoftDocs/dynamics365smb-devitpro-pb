...
|Triggers|[OnPageBackgroundTaskCompleted](triggers/page/devenv-onpagebackgroundtaskcompleted-page-trigger.md)|Runs after a page background task has successfully completed.|
||[OnPageBackgroundTaskError](triggers/page/devenv-onpagebackgroundtaskerror-page-trigger.md)|Runs when an error occurs in a page background task. |
...
2. On the page, complete the following steps:
    ...
    2. Add code to the [OnPageBackgroundTaskCompleted trigger](triggers/page/devenv-onpagebackgroundtaskcompleted-page-trigger.md) to handle the results of the background task and update the UI.
    3. Add code to the [OnPageBackgroundTaskError trigger](triggers/page/devenv-onpagebackgroundtaskerror-page-trigger.md) to handle errors that occur in the background task.
