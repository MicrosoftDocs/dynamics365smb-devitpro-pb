...
To get started writing extensions for [!INCLUDE[d365fin_long_md](../developer/includes/d365fin_long_md.md)] you will need a [!INCLUDE[d365fin_long_md](../developer/includes/d365fin_long_md.md)] tenant, Visual Studio Code, and the [!INCLUDE[d365al_ext_md](../../developer/includes/d365al_ext_md.md)]. Visual Studio Code is a cross platform editor that you will use for coding and debugging.
...
> [!NOTE]  
> If you want to create a container-based sandbox, see [Get started with the Container Sandbox Development Environment](../developer/devenv-get-started-container-sandbox.md). For information about which sandboxes you can choose, see [Choosing Your Dynamics 365 Business Central Development Sandbox Environment](devenv-sandbox-overview.md).
...
3) Download the [[!INCLUDE[d365al_ext_md](../../developer/includes/d365al_ext_md.md)]](https://marketplace.visualstudio.com/items?itemName=ms-dynamics-smb.al). 
