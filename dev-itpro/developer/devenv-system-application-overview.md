...
|Microsoft Entra ID Graph|Interface for the Microsoft Entra ID Graph API.<br><br> **Note** <br>  Microsoft Entra ID Graph is being retired, and we recommend that you start using Microsoft Graph instead. To avoid causing issues with apps that use the Microsoft Entra ID Graph module in [!INCLUDE[prod_short](../developer/includes/prod_short.md)], we haven't changed its name or the names of the objects it contains. For more information about the Microsoft Entra ID Graph retirement, see [Migrate Microsoft Entra ID Graph apps to Microsoft Graph](/graph/migrate-azure-ad-graph-overview).|[ReadMe](https://github.com/microsoft/ALAppExtensions/blob/master/Modules/System/Azure%20AD%20Graph/README.md)|
|Microsoft Entra ID Licensing|Access information about the subscribed SKUs and the corresponding service plans.|[ReadMe](https://github.com/microsoft/ALAppExtensions/blob/master/Modules/System/Azure%20AD%20Licensing/README.md)|
|Microsoft Entra ID Plan|Provides methods for retrieving and managing user plans in Microsoft Entra ID.|[ReadMe](https://github.com/microsoft/ALAppExtensions/blob/master/Modules/System/Azure%20AD%20Plan/README.md)|
|Microsoft Entra ID Tenant|Retrieves information about the Microsoft Entra ID tenant.|[ReadMe](https://github.com/microsoft/ALAppExtensions/blob/master/Modules/System/Azure%20AD%20Tenant/README.md)|
|Microsoft Entra ID User Management|Provides functionality for managing Microsoft Entra ID users.|[ReadMe](https://github.com/microsoft/ALAppExtensions/blob/master/Modules/System/Azure%20AD%20User%20Management/README.md)|
|Microsoft Entra ID User|Retrieves and updates a user from the Microsoft Entra ID Graph API.|[ReadMe](https://github.com/microsoft/ALAppExtensions/blob/master/Modules/System/Azure%20AD%20User/README.md)|
