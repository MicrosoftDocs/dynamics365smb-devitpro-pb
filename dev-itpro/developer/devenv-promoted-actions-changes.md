...
| Promoted categories are never merged into the **Manage** system group anymore. However, if there's a  group called Manage, we'll still do the merge.| If you renamed one of promoted categories to Manage, then they were merged into the Manage system group. |
