...
|5|The generation mode appears while the results are being generated.|Handled automatically by the platform. However, you can customize its caption by calling [Dialog.Open()](methods-auto/dialog/dialog-open-method.md) or [Dialog.Update()](methods-auto/dialog/dialog-update-method.md) from the generate and regenerate actions.|[Customize the genarate mode caption](#customize-the-genarate-mode-caption)|
