...
- The *generate mode* is used while the platform connects to the Azure OpenAI Service and content is being generated. This mode doesn't have any customizable UI. It's a standard dialog that's limited to a message, a link to terms of use, and aan action to stop generating.  
