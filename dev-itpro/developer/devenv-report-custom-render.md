...
## Remarks about file extension and MIME type

When you export a layout or open/edit it through OneDrive in Business Central, the file extension is resolved from the layout metadata, not from report output actions.
