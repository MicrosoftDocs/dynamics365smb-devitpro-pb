...
**Suggested solution (Canceled)**<br>
...
**Suggested solution (InconsistentReadException)**<br>
Ask the user to re-run the report<br><br>

### <a name=IOException></a>IOException
This is a transient error in the Business Central service.

**Suggested solution (IOException)**<br>
Ask the user to re-run the report<br><br>
...
**Suggested solution (NavAdministratorMadeChangesException)**<br>
Ask the user to re-run the report.<br><br>
...
**Suggested solution (NavALException)**<br>
...
**Suggested solution (NavCompanyPermissionException)**<br>
...
**Suggested solution (NavCSideException)**<br>
You need a developer to debug the report or the code running the report. If the report was supplied by Microsoft or an ISV, then create a support request.<br><br>
...
**Suggested solution (NavCSideFilterException)**<br>
...
**Suggested solution (NavCSideRecordNotFoundException)**<br>
...
**Suggested solution (NavCSideSQLLockTimeoutException)**<br>
...
**Suggested solution (NavCSideSqlTimeoutException)**<br>
Ask the user to re-run the report<br><br>
...
**Suggested solution (NavCSideValidateTableRelationException)**<br>
...
**Suggested solution (NavEntitlementPermissionException)**<br>
...
**Suggested solution (NavNCLArgumentOutOfRangeException)**<br>
<br><br>
...
**Suggested solution (NavNCLCallbackNotAllowedException)**<br>
You need a developer to debug the report or the code running the report. If the report was supplied by Microsoft or an ISV, then create a support request.<br><br>
...
**Suggested solution (NavNCLDebuggerActivityAbortedException)**<br>
Not an error<br><br>
...
**Suggested solution (NavNCLDialogException)**<br>
...
**Suggested solution (NavNCLFieldNotFoundException)**<br>
You need a developer to debug the report or the code running the report. If the report was supplied by Microsoft or an ISV, then create a support request.<br><br>
...
**Suggested solution (NavNclHttpRequestException)**<br>
...
**Suggested solution (NavNCLIncompatibleConnectionIntentException)**<br>
<br><br>
...
**Suggested solution (NavNCLNotSupportedTypeException)**<br>
<br><br>

### <a name=NavNCLOutsidePermittedRangeException></a>NavNCLOutsidePermittedRangeException


**Suggested solution (NavNCLOutsidePermittedRangeException)**<br>
<br><br>
...
**Suggested solution (NavNCLRecordNotOpenedException)**<br>
You need a developer to debug the report or the code running the report. If the report was supplied by Microsoft or an ISV, then create a support request.<br><br>
...
**Suggested solution (NavNCLReportDefinitionInvalidException)**<br>
You need a developer to debug the report. If the report was supplied by Microsoft or an ISV, then create a support request.<br><br>
...
**Suggested solution (NavNCLReportNoLayoutException)**<br>
You need a developer to debug the report or the code running the report. If the report was supplied by Microsoft or an ISV, then create a support request.<br><br>
...
**Suggested solution (NavNCLReportResultEmptyException)**<br>
...
**Suggested solution (NavNCLReportSourceExpressionException)**<br>
<br><br>
...
**Suggested solution (NavOfficeDocumentRenderMaxRowsExceededException)**<br>
...
**Suggested solution (NavPermissionException)**<br>
This is not an error in the report, but you might want to look into which users experience this and sort out the permission issue for them.<br><br>

### <a name=NavReportingServiceException></a>NavReportingServiceException
This is a transient error in the Business Central service.

**Suggested solution (NavReportingServiceException)**<br>
Ask the user to re-run the report<br><br>

### <a name=NavSqlException></a>NavSqlException
This is a transient error in the Business Central service.

**Suggested solution (NavSqlException)**<br>
Ask the user to re-run the report<br><br>
...
**Suggested solution (OpenXmlPackageException)**<br>
...
**Suggested solution (XPathException)**<br>
You need a developer to debug the report code or the code running the report<br><br>
