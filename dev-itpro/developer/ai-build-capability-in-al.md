...
An alternative to using the `IsolatedStorage` object, if you're building a Marketplace app, is to use the Marketplace Key Vault. Learn more in [Setting up App Key Vaults for Business Central online](../administration/setup-app-key-vault.md).
