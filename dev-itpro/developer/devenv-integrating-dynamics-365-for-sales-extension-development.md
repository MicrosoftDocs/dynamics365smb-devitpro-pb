...
|[ExternalAccess Property](properties/devenv-externalaccess-property.md)|Fields|Specifies the access to the underlying Common Data Service entity when Common Data Service tables are generated using the **AL Table Proxy Generator** tool, see []()|
