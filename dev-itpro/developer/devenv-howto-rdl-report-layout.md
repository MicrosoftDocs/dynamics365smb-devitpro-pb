...
Report labels defined in the report object and captions included on dataitem colums using the [IncludeCaption property](properties/devenv-includecaption-property.md) are available as parameters in RDL. 
