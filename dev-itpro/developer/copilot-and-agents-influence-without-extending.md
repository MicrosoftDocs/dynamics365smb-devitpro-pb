...
|Summarize|No |Yes |Copilot generates summaries that can include any fields, FactBoxes, actions that use RunObject to lead to other pages, that you add to existing pages, or new card and document page objects from your extension. No action is required to enable this.| 
