...
- Ensure that your tests cover all the setup and usage scenario steps found in the [Building an Advanced Sample Extension](devenv-extension-advanced-example.md) document. This includes Assisted Setup, pages, fields, actions, events, and other controls and objects used by your extension.  
