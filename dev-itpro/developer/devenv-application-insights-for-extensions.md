...
Replace `<connection string>` with the string that you copied in the Azure Application Insights overview. For more information about the format of the Application Insight connection string, see [Connection Strings](azure/azure-monitor/app/sdk-connection-string).
