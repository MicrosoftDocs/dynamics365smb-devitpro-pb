...
The `application` property is used in order to compute the minimum release of Business Central for which your extension will be validated and made available in Business Central.
