...
|[AS0011](appsourcecop-as0011-identifiersmusthaveaffixmd)|An affix is required.|An affix is required.|The identifier '{0}' must have at least one of the mandatory affixes '{1}'.|Extensibility|Error|true|
