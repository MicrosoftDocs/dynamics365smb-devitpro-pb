...
|obsoleteTagMinAllowedMajorMinor|No|The minimum version of ObsoleteTag (Major.Minor) allowed during compilation. Setting this property enables rule [AS0105](appsourcecop-as0105.md).|
