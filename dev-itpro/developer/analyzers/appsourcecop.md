...
|[AS0075](appsourcecop-as0075-obsoletereasonmissingnotallowed.md)|Obsolete Reason must be set.|Obsolete Reason must be set.|The {0} {1} must have specified the reason of Obsoletion.|Design|Warning|true|
