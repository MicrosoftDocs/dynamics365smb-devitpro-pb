...
|[AS0092](appsourcecop-as0092-applicationinsightskeymustbeused.md)|The 'applicationInsightsKey' property must specify the AAD instrumentation key.|Configuration|Error|
