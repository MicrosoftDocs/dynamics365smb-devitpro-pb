---
title: "View that have been published must not be deleted, since dependent extensions may break"
ms.author: solsen
ms.custom: na
ms.date: 04/03/2020
ms.reviewer: na
...
View that have been published must not be deleted, since dependent extensions may break  

## Description
View that have been published must not be deleted.
...
If view was renamed in order to change its display string in the web client, consider using the [Caption](../properties/devenv-caption-property.md) property instead.

If view was renamed in order to comply with naming rules such as [AS0011](appsourcecop-as0011-identifiersmusthaveaffix.md), consider obsoleting the view and introducing a new one.
