...
> [!TIP]  
> To be able to debug an online environment with Embed app published in it, make sure to specify the "applicationFamily" parameter in your launch.json file. You define the application family for your Embed app during onboarding. 
