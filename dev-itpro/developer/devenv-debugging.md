...
- "External code" can only be debugged if the code has the `allowDebugging` flag set. For more information, see [Security Setting and IP Protection](devenv-security-settings-and-ip-protection.md). 
