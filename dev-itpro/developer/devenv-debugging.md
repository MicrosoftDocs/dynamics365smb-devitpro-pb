...
- "External code" can only be debugged if the code has the `allowDebugging` flag set to `true`. For more information, see [Security Setting and Resource Exposure Policy](devenv-security-settings-and-ip-protection.md). 
