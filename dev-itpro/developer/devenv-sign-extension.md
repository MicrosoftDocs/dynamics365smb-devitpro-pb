...
4. Install a signing tool such as [SignTool](https://docs.microsoft.com/dotnet/framework/tools/signtool-exe) or [SignCode](https://docs.microsoft.com/previous-versions/windows/internet-explorer/ie-developer/platform-apis/ms537364(v=vs.85)) to the computer. The sample command will use SignTool.
