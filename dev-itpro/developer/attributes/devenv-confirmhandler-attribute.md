...
```
> [!IMPORTANT]
> The above signature requires the ConfirmHandler method to be *global*. Learn more in [Local and global scope in AL methods](../devenv-al-methods.md%23local-and-global-scope).
