---
title: "JsonToken.SelectTokens(Text, var List of [JsonToken]) Method"
...
# JsonToken.SelectTokens(Text, var List of [JsonToken]) Method
...
## Syntax
```AL
[Ok := ]  JsonToken.SelectTokens(Path: Text, var Result: List of [JsonToken])
```
## Parameters
*JsonToken*  
