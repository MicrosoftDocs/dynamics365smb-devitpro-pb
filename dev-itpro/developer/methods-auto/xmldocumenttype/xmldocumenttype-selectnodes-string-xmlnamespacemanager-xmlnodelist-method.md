...
# XmlDocumentType.SelectNodes(Text, XmlNamespaceManager, var XmlNodeList) Method
...
## Syntax
```AL
[Ok := ]  XmlDocumentType.SelectNodes(XPath: Text, NamespaceManager: XmlNamespaceManager, var NodeList: XmlNodeList)
```
## Parameters
*XmlDocumentType*  
