---
title: "XmlDocumentType.SetPublicId(String) Method"
description: "Sets the public identifier for this Document Type Definition (DTD)."
ms.author: solsen
ms.custom: na
ms.date: 07/07/2021
ms.reviewer: na
...
# XmlDocumentType.SetPublicId(String) Method
