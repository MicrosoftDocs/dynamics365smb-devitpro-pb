---
title: "XmlDocumentType.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method"
...
# XmlDocumentType.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method
...
## Syntax
```AL
[Ok := ]  XmlDocumentType.SelectSingleNode(XPath: Text, NamespaceManager: XmlNamespaceManager, var Node: XmlNode)
```
## Parameters
*XmlDocumentType*  
