---
title: "XmlDocumentType.SelectNodes(Text, var XmlNodeList) Method"
...
# XmlDocumentType.SelectNodes(Text, var XmlNodeList) Method
...
## Syntax
```AL
[Ok := ]  XmlDocumentType.SelectNodes(XPath: Text, var NodeList: XmlNodeList)
```
## Parameters
*XmlDocumentType*  
