...
# System.GetUrl(ClientType, Text, ObjectType, Integer, RecordRef [, Boolean] [, Text]) Method
...
## Syntax
```AL
String :=   System.GetUrl(ClientType: ClientType, Company: Text, ObjectType: ObjectType, ObjectId: Integer, RecordRef: RecordRef [, UseFilters: Boolean] [, Layout: Text])
```
> [!NOTE]
