...
A number is always chosen from the same set of numbers. Use [Randomize Method \(Integer\)](../integer/integer-randomize-method.md) to generate a new set of numbers.  
