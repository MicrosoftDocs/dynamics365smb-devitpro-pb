...
# Open Method
Runs a query object and generates a data set that can be read. The following code shows the syntax of the OPEN function. Query is a variable of the Query data type that specifies the query object.
