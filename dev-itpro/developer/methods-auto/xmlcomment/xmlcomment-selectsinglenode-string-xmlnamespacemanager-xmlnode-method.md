---
title: "XmlComment.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method"
...
# XmlComment.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method
...
## Syntax
```AL
[Ok := ]  XmlComment.SelectSingleNode(XPath: Text, NamespaceManager: XmlNamespaceManager, var Node: XmlNode)
```
## Parameters
*XmlComment*  
