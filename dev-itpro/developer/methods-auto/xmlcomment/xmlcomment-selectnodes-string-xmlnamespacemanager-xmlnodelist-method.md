---
title: "XmlComment.SelectNodes(Text, XmlNamespaceManager, var XmlNodeList) Method"
...
# XmlComment.SelectNodes(Text, XmlNamespaceManager, var XmlNodeList) Method
...
## Syntax
```AL
[Ok := ]  XmlComment.SelectNodes(XPath: Text, NamespaceManager: XmlNamespaceManager, var NodeList: XmlNodeList)
```
## Parameters
*XmlComment*  
