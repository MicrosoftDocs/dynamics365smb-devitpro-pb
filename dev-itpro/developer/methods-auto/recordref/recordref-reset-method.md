...
# Reset Method
Removes all filters, including any special filters set by the MARKEDONLY function (Record) and changes the current key to the primary key. Also removes any marks on the record and clears any AL variables on the record.
