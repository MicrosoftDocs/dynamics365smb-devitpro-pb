...
This method will trigger a JIT load, but allows for triggering the JIT load on multiple fields. If the fields are already loaded, another load won't be triggered.
