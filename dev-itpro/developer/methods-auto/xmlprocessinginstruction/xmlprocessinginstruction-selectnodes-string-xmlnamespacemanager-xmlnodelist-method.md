...
# XmlProcessingInstruction.SelectNodes(Text, XmlNamespaceManager, var XmlNodeList) Method
...
## Syntax
```AL
[Ok := ]  XmlProcessingInstruction.SelectNodes(XPath: Text, NamespaceManager: XmlNamespaceManager, var NodeList: XmlNodeList)
```
## Parameters
