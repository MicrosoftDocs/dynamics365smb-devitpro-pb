---
title: "XmlProcessingInstruction.SelectSingleNode(String, var XmlNode) Method"
...
# XmlProcessingInstruction.SelectSingleNode(String, var XmlNode) Method
...
## Syntax
```AL
[Ok := ]  XmlProcessingInstruction.SelectSingleNode(XPath: String, var Node: XmlNode)
```
## Parameters
