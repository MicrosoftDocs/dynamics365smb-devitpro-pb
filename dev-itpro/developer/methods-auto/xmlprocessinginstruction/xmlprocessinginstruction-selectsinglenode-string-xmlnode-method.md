---
title: "XmlProcessingInstruction.SelectSingleNode(Text, var XmlNode) Method"
...
# XmlProcessingInstruction.SelectSingleNode(Text, var XmlNode) Method
...
## Syntax
```AL
[Ok := ]  XmlProcessingInstruction.SelectSingleNode(XPath: Text, var Node: XmlNode)
```
## Parameters
