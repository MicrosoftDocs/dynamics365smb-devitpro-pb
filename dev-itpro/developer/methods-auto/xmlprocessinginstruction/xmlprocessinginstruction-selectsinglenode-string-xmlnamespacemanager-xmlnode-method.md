---
title: "XmlProcessingInstruction.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method"
...
# XmlProcessingInstruction.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method
...
## Syntax
```AL
[Ok := ]  XmlProcessingInstruction.SelectSingleNode(XPath: Text, NamespaceManager: XmlNamespaceManager, var Node: XmlNode)
```
## Parameters
