---
title: "JsonArray.GetDuration(Integer) Method"
...
# JsonArray.GetDuration(Integer) Method
...
## Syntax
```AL
Value :=   JsonArray.GetDuration(Index: Integer)
```
## Parameters
*JsonArray*  
...
The value at the given index in the JsonArray as a Duration.
