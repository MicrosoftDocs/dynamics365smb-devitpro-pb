---
title: "JsonArray.SelectTokens(Text, var List of [JsonToken]) Method"
...
# JsonArray.SelectTokens(Text, var List of [JsonToken]) Method
...
## Syntax
```AL
[Ok := ]  JsonArray.SelectTokens(Path: Text, var Result: List of [JsonToken])
```
## Parameters
*JsonArray*  
