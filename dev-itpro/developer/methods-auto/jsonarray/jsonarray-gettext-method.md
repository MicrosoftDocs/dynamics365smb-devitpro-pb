---
title: "JsonArray.GetText(Integer) Method"
...
# JsonArray.GetText(Integer) Method
...
## Syntax
```AL
Value :=   JsonArray.GetText(Index: Integer)
```
## Parameters
*JsonArray*  
...
The value at the given index in the JsonArray as a Text.
