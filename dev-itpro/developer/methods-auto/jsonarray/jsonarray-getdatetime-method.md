---
title: "JsonArray.GetDateTime(Integer) Method"
...
# JsonArray.GetDateTime(Integer) Method
...
## Syntax
```AL
Value :=   JsonArray.GetDateTime(Index: Integer)
```
## Parameters
*JsonArray*  
...
The value at the given index in the JsonArray as a DateTime.
