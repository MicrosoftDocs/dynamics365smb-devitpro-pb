---
title: "JsonArray.GetBigInteger(Integer) Method"
...
# JsonArray.GetBigInteger(Integer) Method
...
## Syntax
```AL
Value :=   JsonArray.GetBigInteger(Index: Integer)
```
## Parameters
*JsonArray*  
...
The value at the given index in the JsonArray as a BigInteger.
