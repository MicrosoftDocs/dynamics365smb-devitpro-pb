---
title: "JsonArray.GetChar(Integer) Method"
...
# JsonArray.GetChar(Integer) Method
...
## Syntax
```AL
Value :=   JsonArray.GetChar(Index: Integer)
```
## Parameters
*JsonArray*  
...
The value at the given index in the JsonArray as a Char.
