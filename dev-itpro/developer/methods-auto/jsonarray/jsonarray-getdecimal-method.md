---
title: "JsonArray.GetDecimal(Integer) Method"
...
# JsonArray.GetDecimal(Integer) Method
...
## Syntax
```AL
Value :=   JsonArray.GetDecimal(Index: Integer)
```
## Parameters
*JsonArray*  
...
The value at the given index in the JsonArray as a Decimal.
