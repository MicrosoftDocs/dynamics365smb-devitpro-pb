...
## Static methods
The following methods are available on the Guid data type.


|Method name|Description|
|-----------|-----------|
|[CreateGuid()](guid-createguid-method.md)|Creates a new unique GUID. The value can then be assigned to a GUID data type or a text data type. Use the text data type if you want to compare the GUID to another text string.|
|[CreateSequentialGuid()](guid-createsequentialguid-method.md)|Creates a new sequential unique GUID. Sequential GUIDs perform better when used as a field in a key, because they are partially sequential instead of fully random.|
