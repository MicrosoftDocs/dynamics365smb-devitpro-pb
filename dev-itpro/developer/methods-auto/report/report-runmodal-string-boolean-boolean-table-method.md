---
title: "Report.RunModal(Text [, Boolean] [, Boolean] [, var Record]) Method"
...
# Report.RunModal(Text [, Boolean] [, Boolean] [, var Record]) Method
...
## Syntax
```AL
 Report.RunModal(FullyQualifiedName: Text [, RequestWindow: Boolean] [, SystemPrinter: Boolean] [, var Record: Record])
```
## Parameters
*FullyQualifiedName*  
