...
## Remarks  
 When you use the QUIT method, the report or XMLport is exited without committing any changes that were made to the database during the execution. The [OnPostReport Trigger](../../triggers/report/devenv-onpostreport-report-trigger.md) or [OnPostXMLport Trigger](../../triggers/xmlport/devenv-onpostxmlport-xmlport-trigger.md) trigger will not be called.  
