...
# Report Data Type
Reports are used to display, print or process information from a database.
...
|-----------|-----------|
|[Run(Integer, [Boolean], [Boolean], [var Table])](report-run-method.md)|Loads and executes the report that you specify.|
|[RunModal(Integer, [Boolean], [Boolean], [var Table])](report-runmodal-method.md)|Loads and executes the report that you specify.|
|[SaveAsHtml(Integer, String, [var Table])](report-saveashtml-method.md)|Saves a report as an HTML file. The file is saved on the computer where the server instance is running, and then downloaded to the client when ready. > This function is only supported when a report uses a Word report layout when it is run.|
|[SaveAsXml(Integer, String, [var Table])](report-saveasxml-method.md)|Saves the resulting data set of a query as an .xml file. The following code shows the syntax of the SAVEASXML function. The first line of code is the syntax for an instance function call. The second line of code is the syntax for a static function call.|
|[SaveAsPdf(Integer, String, [var Table])](report-saveaspdf-method.md)|Saves a report as a .pdf file.|
|[SaveAsExcel(Integer, String, [var Table])](report-saveasexcel-method.md)|Saves a report on the computer that is running the server as a Microsoft Excel (.xls) workbook.|
|[SaveAsWord(Integer, String, [var Table])](report-saveasword-method.md)|Saves a report on the computer that is running the server as a Microsoft Word (.doc) document.|
|[WordXmlPart(Integer, [Boolean])](report-wordxmlpart-method.md)|Returns the report data structure as structured XML that is compatible with Microsoft Word custom XML parts. The function has an instance call and a static call. The following code shows the syntax of the WORDXMLPART function. The first line of code is the syntax for an instance function call. The second line of code is the syntax for a static function call.|
...
|[Print(Integer, String, [String], [RecordRef])](report-print-method.md)|Prints a specified report without running the request page. Instead of using the request page to obtain parameters at runtime, the function gets the parameter values as an input parameter string, typically from a RUNREQUESTPAGE function call.|
|[SaveAs(Integer, String, ReportFormat, var OutStream, [RecordRef])](report-saveas-method.md)|Runs a specific report without a request page and saves the report as a PDF, Excel, Word, or XML file. Instead of using the request page to obtain parameters at runtime, the function gets the parameter values as an input parameter string, typically from the return value of a RUNREQUESTPAGE function call.|
...
|[SaveAsHtml(String)](reportinstance-saveashtml-method.md)|Saves a report as an HTML file. The file is saved on the computer where the server instance is running, and then downloaded to the client when ready. > This function is only supported when a report uses a Word report layout when it is run.|
|[SaveAsXml(String)](reportinstance-saveasxml-method.md)|Saves the resulting data set of a query as an .xml file.The following code shows the syntax of the SAVEASXML function. The first line of code is the syntax for an instance function call. The second line of code is the syntax for a static function call.|
...
|[Print(String, [String], [RecordRef])](reportinstance-print-method.md)|Prints a specified report without running the request page. Instead of using the request page to obtain parameters at runtime, the function gets the parameter values as an input parameter string, typically from a RUNREQUESTPAGE function call.|
...
|[SetTableView(var Table)](reportinstance-settableview-method.md)|Applies the table view on the current record as the table view for the page, report, or XmlPort.|
