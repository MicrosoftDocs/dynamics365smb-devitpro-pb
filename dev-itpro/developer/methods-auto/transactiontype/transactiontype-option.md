...
|Report|Report option maps to one of the basic options. This enables a report to use the most concurrent read-only form of data access for the connected server. When you use Microsoft Dynamics NAV Database Server, it maps to Snapshot and when you use SQL Server, it maps to Browse.|
