---
title: "XmlElement.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method"
...
# XmlElement.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method
...
## Syntax
```AL
[Ok := ]  XmlElement.SelectSingleNode(XPath: Text, NamespaceManager: XmlNamespaceManager, var Node: XmlNode)
```
## Parameters
*XmlElement*  
