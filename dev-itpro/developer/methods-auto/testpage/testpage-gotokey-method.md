...
## Remarks
The GoToKey method loops over all records until it finds the identifies row.  For each record, the [OnAfterGetCurrRecord Trigger](../../triggers/page/devenv-onaftergetcurrrecord-page-trigger.md) is executed.  
