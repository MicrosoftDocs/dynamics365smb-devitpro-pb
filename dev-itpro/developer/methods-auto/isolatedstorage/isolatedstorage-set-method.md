...
## Remarks
The **Set** method initiates a write transaction, which means that it cannot be succeeded by code that opens a model page. If you want to open a modal page, it must be done before the **Set** method is called.
