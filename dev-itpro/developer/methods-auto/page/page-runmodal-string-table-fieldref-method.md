---
title: "Page.RunModal(Text, Record, FieldRef) Method"
...
# Page.RunModal(Text, Record, FieldRef) Method
...
## Syntax
```AL
[Action := ]  Page.RunModal(FullyQualifiedName: Text, Record: Record, FieldRef: FieldRef)
```
## Parameters
*FullyQualifiedName*  
