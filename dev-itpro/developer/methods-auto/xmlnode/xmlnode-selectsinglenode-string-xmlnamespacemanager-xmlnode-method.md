---
title: "XmlNode.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method"
...
# XmlNode.SelectSingleNode(Text, XmlNamespaceManager, var XmlNode) Method
...
## Syntax
```AL
[Ok := ]  XmlNode.SelectSingleNode(XPath: Text, NamespaceManager: XmlNamespaceManager, var Node: XmlNode)
```
## Parameters
*XmlNode*  
