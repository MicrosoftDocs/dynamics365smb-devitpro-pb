---
title: "TextConst.IndexOfAny(List of [Char] [, Integer]) Method"
...
# TextConst.IndexOfAny(List of [Char] [, Integer]) Method
...
## Syntax
```AL
Index :=   TextConst.IndexOfAny(Values: List of [Char] [, StartIndex: Integer])
```
## Parameters
*TextConst*  
