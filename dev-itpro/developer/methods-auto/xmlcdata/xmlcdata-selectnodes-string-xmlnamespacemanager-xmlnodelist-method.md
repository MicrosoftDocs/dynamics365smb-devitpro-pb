---
title: "XmlCData.SelectNodes(Text, XmlNamespaceManager, var XmlNodeList) Method"
...
# XmlCData.SelectNodes(Text, XmlNamespaceManager, var XmlNodeList) Method
...
## Syntax
```AL
[Ok := ]  XmlCData.SelectNodes(XPath: Text, NamespaceManager: XmlNamespaceManager, var NodeList: XmlNodeList)
```
## Parameters
*XmlCData*  
