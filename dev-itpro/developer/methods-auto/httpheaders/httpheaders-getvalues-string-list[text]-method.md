---
title: "HttpHeaders.GetValues(String, List of [Text]) Method"
...
# HttpHeaders.GetValues(String, List of [Text]) Method
...
## Syntax
```AL
[Ok := ]  HttpHeaders.GetValues(Key: String, Values: List of [Text])
```
## Parameters
*HttpHeaders*  
