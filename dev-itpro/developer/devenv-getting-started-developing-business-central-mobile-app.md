...
To complete designing your [!INCLUDE[nav_uni_app](includes/nav_uni_app_md.md)] solution, you should consider offering users Help, to guide them through pages or workflows. For more information about adding help to your solution, see [Extend and Collaborate on the Help for Dynamics 365 Business Central](../help/contributor-guide.md).
