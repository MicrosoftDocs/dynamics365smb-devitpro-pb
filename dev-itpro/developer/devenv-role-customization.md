...
- In the client, profiles are managed from the **Profiles** page. For more information, see [Understanding Users, Roles, and Profiles](https://docs.microsoft.com/en-us/dynamics365/business-central/admin-users-profiles-roles) in the [!INCLUDE[prodshort](includes/prodshort.md)] Application Help.
