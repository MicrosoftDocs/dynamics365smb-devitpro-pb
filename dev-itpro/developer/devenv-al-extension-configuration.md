...
|Enable Script IntelliSense|Specifies whether IntelliSense should be enabled for control addin script files. Disable this if it interferes with advanced JavaScript or TypeScript configurations. Default is `true`.|
