...
|Dynamics GP migration|**Recurring purchase and sales lines creation:** The Dynamics GP migration tool supports automatic creation of recurring purchase and sales lines in Business Central from Dynamics GP Purchasing and Sales Accounts. When enabled in migration settings, it evaluates vendor/customer accounts, class accounts, and default purchasing/sales accounts in Dynamics GP, then generates corresponding recurring lines in Business Central. Each line is linked to the appropriate vendors or customers, includes mapped dimensions, and is set to insert automatically on purchase or sales documents. This option is off by default. Learn more in [Generating recurring purchase lines](../administration/migrate-dynamics-gp.md#creating-recurring-purchase-lines) and [Generating recurring sales lines](../administration/migrate-dynamics-gp.md#recurring-sales-lines). | General availability |
