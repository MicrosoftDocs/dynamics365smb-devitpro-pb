...
| | [Capture more sales with enhanced Sales Order Agent](/dynamics365/release-plan/2025wave1/smb/dynamics365-business-central/capture-more-sales-enhanced-sales-order-agent), with added skills to work with multiple ship-to addresses and suggest alternatives for the items which cannot be delivered at desired time. This release enables agent administrators to configure more autonomous processing of the customer requests, as well as giving more options for dealing with ambiguous situations - providing [additional instructions expressed in natural language](https://learn.microsoft.com/en-us/dynamics365/release-plan/2025wave2/smb/dynamics365-business-central/give-more-instructions-agent-when-review-its-tasks), to help the agent move forward with the task. The Sales Order Agent is now available in more countries and more languages, entering public preview in Denmark, Germany, Spain, France and Italy. [Set up and try the Sales Order Agent](https://learn.microsoft.com/en-us/dynamics365/business-central/sales-order-agent-setup) for your scenarios and see how it can help you capture more sales by automating creation of quotes and orders as well as applying updates requested by customers.| PP  |
