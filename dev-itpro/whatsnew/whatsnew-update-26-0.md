...
| Product Area              | Feature                         | Release Plan URL              |
|-------------------------------|---|-----------------|
| Application                   | Integrate Field Service with service management                                          | integrate-field-service-service-management.md               |
| Application                   | View item availability in Field Service work orders                                         | view-item-availability-field-service-work-orders.md                                    |
| Application                   | Use improved troubleshooting options for cost adjustments                                   | improved-performance-enhanced-troubleshooting-options-cost-adjustment-runs.md          |
| Application                   | Edit price lists in Excel                                                                   | edit-price-lists-excel.md                                                              |
| commerce                      | Import and export more data for Shopify B2B companies and company locations                 | import-export-more-data-shopify-b2b-companies-company-locations.md                     |
| commerce                      | Activate sales channels in Shopify Connector                                                | activate-sales-channels-shopify-connector.md                                           |
| commerce                      | Import and export more data using Shopify metafields                                        | import-export-more-data-using-shopify-metafields.md                                    |
| commerce                      | Troubleshoot export issues on Shopify Skipped Records page                                  | troubleshoot-export-issues-shopify-skipped-records-page.md                             |
| commerce                      | Use the latest update for the Shopify connector                                             | use-latest-update-shopify-connector.md                                                 |
| Copilot and AI                | Enhance purchase order line matching with Copilot                                           | enhance-purchase-order-line-matching-copilot.md                                        |
| Copilot and AI                | Summarize with Copilot                                                                      | summarize-record-copilot.md                                                            |
| Copilot and AI                | Autofill fields with Copilot                                                                | autofill-fields-copilot.md                                                             |
| Country and regional          | Post cash documents to projects in Czech localization                                       | post-cash-documents-projects-czech-localization.md                                     |
| Country and regional          | Add more text in cash documents in Czech localization                                       | add-more-text-cash-documents-czech-localization.md                                     |
| Country and regional          | Use Peppol PINT A-NZ format for e-documents in AU and NZ                                    | use-peppol-a-nz-format-e-documents-australia-new-zealand.md                            |
| Country and regional          | Calculate GST on recurring journals for India                                               | calculate-gst-recurring-journals-india.md                                              |
| Country and regional          | Showcase Business Central with Czech localization demos                                     | showcase-business-central-czech-localization-demos.md                                  |
| Country and regional          | Use VAT Return to report VAT in local and functional currencies in Czech Republic           | use-vat-return-report-vat-local-functional-currencies-czech-republic.md                |
| Country and regional          | Use modern search to access data in Czech localization                                      | use-modern-search-access-data-czech-localization.md                                    |
| Country and regional          | Hide lines with zero quantity in Czech document reports                                     | hide-lines-zero-quantity-czech-document-reports.md                                     |
| Country and regional          | Define allowed languages per environment                                                    | define-allowed-languages-per-environment.md                                            |
| Development                   | Manage external files more easily through a unified API in the External File Storage module |                                                                                        |
| Development                   | Troubleshoot clients, apps, and add-ins with telemetry                                      | troubleshoot-clients-apps-add-ins-telemetry.md                                         |
| Development                   | Validate certificates on external web service endpoints called from AL HttpClient           | validating-certificates-external-web-service-endpoints-called-al-httpclient.md         |
| Development                   | Use new properties on a report layout                                                       | use-new-properties-report-layout.md                                                    |
| Development                   | Embed Power BI content in web client with new page type                                     | embed-power-bi-content-web-client-new-page-type.md                                     |
| Development                   | Overloaded JsonObject data type GetValue method                                             | overloaded-jsonobject-data-type-getvalue-method.md                                     |
| Development                   | Move tables and fields with data across extensions as part of refactoring                   | move-tables-fields-data-across-extensions-as-part-refactoring.md                       |
| Development                   | Extend CardPageId on list and listpart pages                                                | extend-cardpageid-list-listpart-pages.md                                               |
| Development                   | Use the new continue keyword for AL loops                                                   | use-new-continue-keyword-al-loops.md                                                   |
| Development                   | Read and write YAML in AL using JsonObject                                                  | read-write-yaml-al-using-jsonobject.md                                                 |
| Development                   | Select extensions to open in Visual Studio Code from the web client                         | select-extensions-open-visual-studio-code-web-client.md                                |
| Development                   | Mock outbound HttpClient web service calls during testing                                   | mock-outbound-httpclient-web-service-calls-during-testing.md                           |
| Development                   | Search, navigate and use app symbols as context for GitHub Copilot                          | search-navigate-use-app-symbols-as-context-github-copilot.md                           |
| Development                   | View build metadata in Extension Management page                                            | view-build-metadata-extension-management-page.md                                       |
| Development                   | Work with multiline strings in AL                                                           | work-multiline-strings-al.md                                                           |
| Development                   | Self-service App Key Vault onboarding for AppSource apps                                    | self-service-app-key-vault-onboarding-appsource-apps.md                                |
| Development                   | Use new IncStr parameter to change integers by more than 1 in string variables              | use-new-incstr-parameter-change-integers-more-than-1-string-variables.md               |
| Development                   | Convert simple type values to text using new ToText method                                  | convert-simple-type-values-text-using-new-totext-method.md                             |
| Development                   | Create lists and dictionaries of interfaces in AL                                           | create-list-dictionary-interfaces-al.md                                                |
| Development                   | Generate launch json file from the web client                                               | generate-launchjson-file-web-clientjson-file-from-the-web-client.md                    |
| Development                   | Running objects in actions defaults to UI descriptors on target object                      | running-objects-actions-defaults-caption-tooltip-abouttext-abouttitle-target-object.md |
| Documents                     | Generate multiple incoming e-documents for multiple attachments                             | generate-multiple-incoming-e-documents-multiple-attachments.md                         |
| Documents                     | Automate embedded attachments in PEPPOL                                                     | automate-embedded-attachments-peppol.md                                                |
| Documents                     | Use Logiq as a service provider for e-documents                                             | use-new-service-providers-e-documents-framework.md                                     |
| Documents                     | Use ExFlow by SignUp connector for e-documents                                              | use-exflow-signup-connector-e-documents.md                                             |
| Documents                     | Process e-documents in two steps                                                            | process-e-documents-two-steps.md                                                       |
| Documents                     | Extend E-Documents features using a new interface                                           | extend-e-documents-features-using-new-interface.md                                     |
| Financial Management          | Require Intrastat classifications on documents                                              | require-intrastat-classifications-documents.md                                         |
| Financial Management          | Check total purchase amounts on documents                                                   | check-total-purchase-amounts-documents.md                                              |
| Governance and administration | Link to Power Platform to use Copilot Studio messages                                       | link-power-platform-use-copilot-studio-messages.md                                     |
| Governance and administration | Add support for MultiSubnetFailover                                                         | add-support-multisubnetfailover.md                                                     |
| Governance and administration | Enhanced index troubleshooting                                                              |                                                                                        |
| Reporting and data analysis   | Use enhanced analytics for inventory                                                        |                                                                                        |
| Reporting and data analysis   | Enhance reports with PDF post-processing capabilities                                       | enhance-reports-pdf-post-processing-capabilities.md                                    |
| Reporting and data analysis   | Validate report layouts for errors as an admin                                              | validate-report-layouts-errors-as-admin.md                                             |
| Reporting and data analysis   | Access report and request metadata in Word layouts                                          | access-report-request-metadata-word-layouts.md                                         |
| Reporting and data analysis   | Use enhanced Financial Reporting capabilities                                               | use-enhanced-financial-reporting-capabilities.md                                       |
| Service and platform          | Calculate values only for visible FlowFields                                                | calculate-values-only-visible-flowfields.md                                            |
| Supply chain management       | Reschedule production orders within a safety lead time                                      | reschedule-production-orders-within-safety-lead-time.md                                |
| Supply chain management       | Use enhanced customer document layout for service management                                | use-enhanced-customer-document-layout-service-management.md                            |
| Supply chain management       | Cancel production orders that have consumption                                              | cancel-production-orders-that-have-consumption.md                                      |
| Supply chain management       | Add more columns to various pages to gain more insight                                      | add-more-columns-various-pages-gain-more-insight.md                                    |
| Supply chain management       | Experience improved usability in manufacturing                                              | experience-improved-usability-manufacturing.md                                         |
| Supply chain management       | Enable overpicking for production orders                                                    | enable-over-picking-production-orders.md                                               |
| Supply chain management       | Achieve greater accuracy in manufacturing costing                                           | achieve-greater-accuracy-manufacturing-costing.md                                      |
| Supply chain management       | Omit warehouse pick for manual flushing methods                                             | omit-warehouse-pick-manual-flushing-methods.md                                         |
| Supply chain management       | Receive project items with receipts or put-aways                                            | receive-project-items-receipts-or-put-aways.md                                         |
| Supply chain management       | Block items or variants from production output                                              | block-items-or-variants-production-output.md                                           |
| Supply chain management       | Avoid document number errors when you post project journals                                 | avoid-document-number-errors-when-post-project-journals.md                             |
| Supply chain management       | Handle production output with warehouse put-aways                                           | handle-production-output-warehouse-put-aways.md                                        |
| Supply chain management       | Reopen finished production orders                                                           | reopen-finished-production-orders.md                                                   |
| Supply chain management       | Use streamlined product design tools in manufacturing                                       | use-streamlined-product-design-tools-manufacturing.md                                  |
| Supply chain management       | Print barcodes from production orders                                                       | print-barcodes-production-orders.md                                                    |
| Supply chain management       | Manage document attachments in manufacturing                                                | manage-document-attachments-manufacturing.md                                           |
| Supply chain management       | Use Edit in Excel on output, consumption, and item journals                                 | edit-item-tracked-items-excel-output-consumption-item-journals.md                      |
| Supply chain management       | Combine service shipments on a single service invoice                                       | combine-service-shipments-single-service-invoice.md                                    |
| Supply chain management       | Allow multiple people to post inventory at the same time                                    | allow-multiple-people-post-inventory-at-same-time.md                                   |
| Supply chain management       | Create demo data for Subscription Billing with demo data tool                               | create-demo-data-subscription-billing-contoso-demo-data-tool.md                        |
| Supply chain management       | Create subscription contract lines manually                                                 | create-subscription-contract-lines-manually.md                                         |
| Supply chain management       | Add unit cost in subscription lines                                                         | add-unit-cost-subscription-lines.md                                                    |
| Supply chain management       | Track and rebill quantity changes in subscriptions                                          | track-rebill-quantity-changes-subscriptions.md                                         |
| Supply chain management       | Align Subscription Billing with standard user experience and terminology                    | align-subscription-billing-standard-user-experience-terminology.md                     |
| Sustainability Management     | Specify default sustainability values for various entities                                  | specify-default-sustainability-values-various-entities.md                              |
| Sustainability Management     | Capture sustainability data with general journals                                           | capture-sustainability-data-general-journals.md                                        |
| Sustainability Management     | Use water and waste management with sustainability                                          | use-water-waste-management-sustainability.md                                           |
| Sustainability Management     | Enable sustainability Scope 3 value chain for assembly and transfers                        | enable-sustainability-scope-3-value-chain-assembly-transfers.md                        |
| Sustainability Management     | Provide carbon equivalent data for sales based on Scope 3 automation                        | provide-carbon-equivalent-data-sales-based-scope-3-automation.md                       |
| Sustainability Management     | Start value chain in purchase process for Scope 3 in sustainability                         | start-value-chain-purchase-process-scope-3-sustainability.md                           |
| Sustainability Management     | Use refreshed demo data for Sustainability                                                  | use-refreshed-demo-data-sustainability.md                                              |
| Sustainability Management     | Use sustainability Scope 3 value chain in manufacturing                                     | use-sustainability-scope-3-value-chain-manufacturing.md                                |
| Sustainability Management     | Use the new Out of Scope emission category                                                  | use-new-out-scope-emission-category.md                                                 |
| User experiences              | Preview PDF attachments directly in web client                                              | preview-pdf-attachments-directly-web-client.md                                         |
| User experiences              | Adjust the FactBox pane width                                                               | allow-adjusting-factbox-pane-width.md                                                  |
| User experiences              | Use user interface enhancements for better experience                                       | use-user-interface-enhancements-better-experience.md                                   |
-->
| Product Area              | Feature                         |
|---------------------------|---------------------------------|
