...
| Learn how entitlements can be used to support transactability for Marketplace apps | [Supporting transactability for Marketplace apps](../developer/devenv-entitlement-object.md#supporting-transactability-for-marketplace-apps)
