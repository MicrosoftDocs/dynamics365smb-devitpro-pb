...
### Auto-generated content in the developer and IT Pro content

Some of the content in the developer and IT Pro help is auto-generated from the product code. This content reflects the source code at the time of the release. You can tell that the content is auto-generated when it contains a note like illustrated with the `CommitBehavior` option type in the [CommitBehavior option type example](contributor-guide.md#commitbehavior-option-type-example). The auto-generated content has a `(START>DO_NOT_EDIT)` and a `(IMPORTANT: END>DO_NOT_EDIT)` section, which is overwritten when the content is regenerated. Any change needed to the content should be made in the source code, not in the Markdown file. But, if you want to add a note, a tip, a remark, or an example, you can do that in the Markdown file after the `(IMPORTANT: END>DO_NOT_EDIT)` section. This is illustrated in the [Example of adding a note to auto-generated content](contributor-guide.md#example-of-adding-a-note-to-auto-generated-content). 
...
#### Example of adding a note to auto-generated content
