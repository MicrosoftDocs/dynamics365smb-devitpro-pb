...
- **Prompt dialog**
   ...
   This propmpt dialog is a flexible, in-app UI window that's designed for generative AI features that have distinct inputs and outputs. It exhibits the signature Microsoft AI visual elements, and Responsible AI controls such as notifying the user that the content is generated by AI
