---
title: Create and activate a playground agent (preview)
...
Before you can create a playground agent, ensure that you have the following prerequisites in place:
