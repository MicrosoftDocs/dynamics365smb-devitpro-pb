...
|command|The development command that you want to run. The possible values are as follows:<br /><br /> [BuildVirtualMetadata](#BuildVirtualMetadata)<br />[CreateDatabase](#CreateDatabase.md)<br />[UpgradeDatabase](#UpgradeDatabase.md)<br /> [CompileObjects](#CompileObjects.md)<br />[DeleteObjects](#DeleteObjects.md)<br />[ExportObjects](#ExportObjects.md)<br />[ImportObjects](#ImportObjects.md)<br />[ExportLangModule](#ExportLangModule.md)<br />[ImportLangModule](#ImportLangModule.md)<br />[ExportTranslate](#ExportTranslate.md)<br />[ImportTranslate](#ImportTranslate.md)<br />[ExportToNewSyntax](#ExportToNewSyntax.md)<br />[GetBuildVersion](#GetBuildVersion.md)<br /> [GenerateSymbolReference](#GenerateSymbolReference)|Not applicable|  
...
|navserverinstance|Specifies the [!INCLUDE[server](../developer/includes/server.md)] instance that is being used, such as [!INCLUDE[nav_server_instance](../developer/includes/nav_server_instance_md.md)].|[CompileObjects](CompileObjects.md)<br /><br /> [DeleteObjects](#DeleteObjects)<br /><br /> [ImportObjects](#ImportObjects)|  
