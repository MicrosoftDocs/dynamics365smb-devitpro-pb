...
|-----------|-----------|
|[Length()](bigtext-length-method.md)|Retrieves the length of a BigText variable.|
...
|[TextPos(String)](bigtext-textpos-method.md)|Gets the position at which a specific string first occurs in a BigText.|
